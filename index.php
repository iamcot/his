...
function configNew(&$bn,&$bv,&$f,$i,&$uid)
{
  ...
  //$timer->start('main');
  //$timer->start('client1');
  $sniffer_settings = array('check_cookies'=>$cc,'default_language'=>$vi,'allow_masquerading'=>$am);
...
if(file_exists($lang_file)) {
    ...
    include('language/en/lang_vi_startframe.php');  # en = english is the default language table
	$lang='vi';
}
