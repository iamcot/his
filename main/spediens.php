...
$aSubMenuItem=array('LDPlugins' => '<a href="'.$root_path.'plugins/plugins.php'.URL_APPEND.'">'.$LDPlugins.'</a>',
					...
					'LDICD10' => '<a href="'.$root_path.'modules/drg/icd10_mange_pass.php'.URL_APPEND.'">'. $LDICD10.'</a>',
					'LDDeptManage' => '<a href="'.$root_path.'modules/dept_admin/dept_manage_pass.php'.URL_APPEND.'">'. $LDDeptManage.'</a>',
					'LDTimeKeeping' => '<a href="'.$root_path.'modules/timekeeping/tkp-main-pass.php'.URL_APPEND.'">'. $LDTimeKeeping.'</a>',
					...
					'LDNews' => (($_SESSION['sess_login_userid']=='admin')?'<a href="'.$root_path.'modules/news/headline-edit.php'.URL_APPEND.'">'.$LDNews.'</a>':''),//edit 0410- cot
