                ...
                if($bprows){                        
                    ...
                    {                        
                        ...
                        if($bp['cotucung']>=3 && $i==0){
                            ...
                            imagettftext($im, $size, 0, $ox2_1, $height, $text_color_1, $font, $oy2);        
							imagettftext($im, $size, 0, $ox2_1, $height1, $text_color_1, $font, $oy2_1);
                        }else{
                            if($ox1_1!=0){
                                $ox1=$ox1_1;
                                $ox2_1=0;
                        ...
                        imagettftext($im, $size, 0, $ox2, $height, $text_color_1, $font, $oy2);                         
                        imagettftext($im, $size, 0, $ox2, $height1, $text_color_1, $font, $oy2_1);
                        $ox1=$ox2;
                        $ox1_1=$ox2_1;
                        $oy1=$oy2;
                        $time_bf=$bp['msr_time'];//$time[0];
                ...
                if($bprows){                        
                    ...
                    {                        
                        ...
                        if($bp['cotucung']>=3 && $i==0){
                            ...
                            imagettftext($im, 10, 0, $ox_time+5, $tabhi-27, $text_color_1, $font, $time['0'].'g'.$time['1']);
							...
							imagettftext($im, 10, 0, $ox_time-($tabcols/2)+7, $tabhi-20, $text_color_1, $font, $time['0'].'g'.$time['1']);
							imagettftext($im, 10, 0, $ox2_1-2, $tabhi-20, $text_color_1, $font, $time['0'].'g'.$time['1']);
							
                            $oy2=((10-$bp['cotucung'])*$tabcols);
                            $oy2_1=((10-$bp['dolot'])*$tabcols);
                            if($ox2_1!=0 && $count<2){
                            ...
                            if($i==0){
								...
								imagettftext($im, 10, 0, $ox_time-($tabcols/2)+5, $height, $text_color_1, $font, $time['0'].'g'.$time['1']);                              
                            }
                            $oy2=((10-$bp['cotucung'])*$tabcols)+5;
                            $oy2_1=((10-$bp['dolot'])*$tabcols)+5;
                        }                                                
                ...
                if($bprows){                        
                    ...
                    {                        
                        ...
                        if($bp['cotucung']>=3 && $i==0){
                            ...
                            imagettftext($im, 12, 0, $ox2_1, $height, $text_color_1, $font, $oy2['1']);
                            imagettftext($im, 12, 0, $ox2_1, $height1, $text_color_1, $font, $oy2['2']);
                            imagettftext($im, 12, 0, $ox2_1, $height2, $text_color_1, $font, $oy2['3']);
                            $count++;
                            $ox1_1=$ox2_1;
                        }else{
                            if($ox1_1!=0){
                        ...
                        imagettftext($im, 10, 0, $ox2, $height, $text_color_1, $font, $oy2['1']);
                        imagettftext($im, 10, 0, $ox2, $height1, $text_color_1, $font, $oy2['2']);
                        imagettftext($im, 10, 0, $ox2, $height2, $text_color_1, $font, $oy2['3']);
                        $ox1=$ox2;
                        $oy1=$oy2;
						/*if((int)$time[1]>=45){
							$time[0]+=1;
