    ...
    */
    ...
    if($dblink_ok){	
        ...
        $sql="SELECT * FROM $dbtable
                ...
                AND ((lanmangthai='' AND lansinh='') OR (lanmangthai=0 AND lansinh=0))
                ...
                if($bprows){                        
                    ...
                    {                        
                        ...
                        if($bp['cotucung']>=3 && $i==0){
                            ...
                            if($time[1]>0){
                                $ox2=$ox1+$h*$xoffs+($time[1]*$xunit)+5;
                            }else{
                                $ox2=$ox1+$h*$xoffs; 
                            } 
                            if(3<=$bp['cotucung'] && $bp['cotucung']<4){
                ...
                if($bprows){                        
                    ...
                    {                        
                        ...
                        if($bp['cotucung']>=3 && $i==0){
                            ...
                            imagettftext($im, 10, 0, $ox_time+5, $tabhi-10, $text_color_1, $font, $time['0'].'g'.$time['1']);
                            ...
                            if((int)$p>0){
                                $ox2=$ox1+($time['1']*$xunit+$h*$tabcols)-2;  
								$ox_time=$ox1+$h*$tabcols+$time[1]*$xunit;
                                imagettftext($im, 10, 0, $ox_time, $tabhi-20, $text_color_1, $font, $time['0'].'g');
								imagettftext($im, 10, 0, $ox_time, $tabhi-5, $text_color_1, $font, $time['1'].'p');
                                imagettftext($im, 10, 0, $ox2_1-2, $tabhi-20, $text_color_1, $font, $time['0'].'g');
								imagettftext($im, 10, 0, $ox2_1-2, $tabhi-5, $text_color_1, $font, $time['1'].'p');
                            }else{
                                $ox2=$ox1+($h*$tabcols)-2; 
								$ox_time=$ox1+$h*$tabcols;
                                imagettftext($im, 10, 0, $ox_time-3, $tabhi-20, $text_color_1, $font, $time['0'].'g');
								imagettftext($im, 10, 0, $ox_time-3, $tabhi-5, $text_color_1, $font, $time['1'].'p');
                                imagettftext($im, 10, 0, $ox2_1-3, $tabhi-20, $text_color_1, $font, $time['0'].'g');
								imagettftext($im, 10, 0, $ox2_1-3, $tabhi-5, $text_color_1, $font, $time['1'].'p');
                            }
                            $oy2=((10-$bp['cotucung'])*$tabcols)+5;
                            $oy2_1=((10-$bp['dolot'])*$tabcols)+5;
                            if($ox2_1!=0 && $count<2){
                            ...
                            if($i==0){
                                ...
                                if($time['1']>0){
									...
									imagettftext($im, 10, 0, $ox2, $tabhi-5, $text_color_1, $font, $time['1'].'p');
                                }else{
                                    imagettftext($im, 10, 0, $ox2, $tabhi-20, $text_color_1, $font, $time['0'].'g');
                                }
                            }else{
                                ...
                                if((int)$time['1']>0){
                                    $ox2=$ox1+($p*$xunit+$h*$tabcols); 
									$ox_time=$ox1+$h*$tabcols+$time[1]*$xunit+5;
                                    imagettftext($im, 10, 0, $ox_time-($tabcols/2)+7, $tabhi-20, $text_color_1, $font, $time['0'].'g');
									imagettftext($im, 10, 0, $ox_time-($tabcols/2)+7, $tabhi-5, $text_color_1, $font, $time['1'].'p');
                                }else{
                                    $ox2=$ox1+($h*$tabcols); 
									$ox_time=$ox1+$h*$tabcols;
                                    imagettftext($im, 10, 0, $ox_time-($tabcols/2)+7, $tabhi-10, $text_color_1, $font, $time['0'].'g');
                                }
                            }
                            $oy2=((10-$bp['cotucung'])*$tabcols)+5;
                            $oy2_1=((10-$bp['dolot'])*$tabcols)+5;
                    ...
                    {                        
                        ...
                        if($bp['cotucung']>=3 && $i==0){
                            ...
                            if( 20<=$bp['sogiay'] && $bp['sogiay']<=40){
								...
								$src = imagecreatefrompng($root_path.'gui/img/common/default/soc_kevuong_bdcd.png');
                                imagecopyresized($im, $src, $ox2_1+1, $oy2+1, 0, 0, ($tabcols*2)-2, 151, 195, 151);
							}
                            //ve duong day
                        ...
                        //ve duong day
                        ImageLine($im,$ox2,$tabhi-1,$ox2+($tabcols*2),$tabhi-1,$text_blue);
                        $ox1=$ox2;
                        $oy1=$oy2;
						/*if((int)$time[1]>=45){
							$time[0]+=1;
        ...
        case 6:
            ...
            if($ok){
                ...
                if($bprows){                        
                    for($i=0;$i<$bprows;$i++)
                    {                        
                        $bp=$bp_obj->FetchRow();    //||empty($bp['thuoc']                    
                        if(empty($bp['msr_time'])||(!empty($bp['lanmangthai']) || !empty($bp['lansinh']) || !empty($bp['giooivo']))) continue;
                        $time=explode(':',$bp['msr_time']);
                        imagesetthickness($im, 5);  
                        if($bp['cotucung']>=3 && $i==0){
                            ...
                            $ox2=$ox1+($h*$tabcols); 
                            $ox2_1+=$tabcols/4;
                            imagettftext($im, 14, 90, $ox2_1+4, $tabhi-20, $text_color_1, $font, $bp['thuoc']);
                            $count++;
                            $ox1_1=$ox2_1;
                        }else{
							if($ox1_1!=0){
                        ...
                        imagettftext($im, 14, 90, $ox2+4, $tabhi-20, $text_color_1, $font, $bp['thuoc']);
                        $ox1=$ox2;
                        $oy1=$oy2;
						/*if((int)$time[1]>=45){
							$time[0]+=1;
