...
*/  
	...
	if($ttf_ok){
    	ImageTTFText($namelabel,11,0,$lmargin,$tmargin+3,$nm_black,$arial,$dataline1);
    	ImageTTFText($namelabel,10,0,$lmargin,$tmargin+16,$nm_black,$arial,$dataline2);
