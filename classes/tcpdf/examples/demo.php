...
<table cellspacing="0" cellpadding="1" border="1">
    <tr>
        <td rowspan="3">Cột 1 - Dòng 1<br />COLSPAN 3</td>
        <td>COL 2 - ROW 1</td>
        <td>COL 3 - ROW 1</td>
    </tr>
    <tr>
        <td rowspan="2">Cột 2 - Dòng 2 - COLSPAN 2<br />text line<br />text line<br />text line<br />text line</td>
        <td>COL 3 - ROW 2</td>
    </tr>
    <tr>
       <td>COL 3 - ROW 3</td>
...
<table cellspacing="0" cellpadding="1" border="1">
    <tr>
        <td rowspan="3">COL 1 - ROW 1<br />COLSPAN 3<br />text line<br />text line<br />text line<br />Theo khảo sát của Hiệp hội doanh nghiệp dược Việt Nam, trong tháng 4 thuốc nội tăng giá nhiều và tăng cao hơn thuốc ngoại. <br />Cụ thể, trong số gần 12.700 lượt mặt hàng thuốc nội thì có 65 loại tăng giá<br />text line</td>
        <td>COL 2 - ROW 1</td>
        <td>COL 3 - ROW 1</td>
    </tr>
    <tr>
