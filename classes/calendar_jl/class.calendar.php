...
*/			
		...
		echo "						</SELECT>
									<SELECT name=\"currYear\" id=\"currYear\" class=\"SelectMisc\" onChange=\"location.href = '$PHP_SELF".URL_REDIRECT_APPEND."&currYear=' + this.value + '&currMonth=' +  + document.CalOptions.currMonth.value;\">
		";
