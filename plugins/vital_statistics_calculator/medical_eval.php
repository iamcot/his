...
<H1 align=center><FONT color=#000080><?php echo $LDPersonalPhysicalEval; ?></FONT></H1><FONT color=#008000>
...
<TABLE cellSpacing=4 cellPadding=2 border=3 bordercolorlight="#C0C0C0" bordercolordark="#808080" style="border-collapse: collapse" bordercolor="#111111" bgcolor="#CCCCCC">
  <TBODY>
  <TR>
    <TD align="right"><font size="2"><?php echo $LDTuoi; ?></font></TD>
  ...
  <TR>
    <TD align="right"><font size="2"><?php echo $LDSex; ?></font></TD>
  ...
  <TR>
    <TD align="right"><font size="2"><?php echo $LDWeight.' (kg)'; ?></font><font size="2" color="#ff0080">*</font></TD>
  ...
  <TR>
    <TD align="right"><font size="2"><?php echo $LDWeight.' (Lbs)'; ?></font>
  ...
  <TR>
    <TD align="right"><font size="2"><?php echo $LDWaist.' (cm)'; ?></font><font size="2" color="#ff0080">*</font></TD>
  ...
  <TR>
    <TD align="right"><font size="2"><?php echo $LDWaist.' (inches)'; ?></font>
    <font size="2" color="#ff0080">*</font></TD>
  ...
  <TR>
    <TD align="right"><font size="2"><?php echo $LDHeight.' (cm)'; ?></font>
    <font size="2" color="#ff0080">*</font></TD>
    <TD><INPUT tabIndex=7 
      onchange="if(!isNaN(this.value)) {return true;} else {this.focus(); this.select(); alert('Jepni nje numer');}" 
      size=3 value=0.1 name=htincms></TD></TR>
  <TR>
    <TD align="right"><font size="2"><?php echo $LDHeight.' (feet & inches)'; ?></font>
    <font size="2" color="#ff0080">*</font></TD>
  ...
  <TR>
    <TD align="right"><font size="2"><?php echo $LDPulse; ?> </font> </TD>
    <TD><INPUT tabIndex=10 maxLength=3 
      onchange="if(!isNaN(this.value)) {return true;} else {this.focus(); this.select(); alert('Jepni nje numer');}" 
      size=3 value=72 name=prate><font size="2"><?php echo $LDnpm; ?> </font></TD></TR>
  <TR>
    <TD align="right"><font size="2"><?php echo $LDSystolic.' (mmHg)'; ?></font></TD>
    <TD><INPUT tabIndex=11 maxLength=3 
      ...
      size=3 value=120 name=bps><font size="2"><?php echo $LDSystolic1.' ,'; ?> </font> <INPUT tabIndex=12 maxLength=3 
      onchange="if(!isNaN(this.value)) {return true;} else {this.focus(); this.select(); alert('Please enter a number');}" 
...
<CENTER>
    ...
    <button name="clearit" type="reset"><font face="Verdana">Refresh</font></button></CENTER></DIV></FORM>
<P align=center><font face="Verdana"><font size="2" color="#ff0080">*</font><font size="2">
</font> <FONT color=#ff00ff><SMALL><?php echo $LDNoteLogarit; ?></SMALL><font size="2"><BR>
</font></FONT></font><FONT color=red><font face="Verdana"><B><font size="2"><?php echo $LDNoteLogarit1;?></font></B></font> 
</FONT></P>
</FONT>
