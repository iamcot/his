...
*/
$sPluginName = 'Thang đo sức khỏe';//'Statistika Vitale';

/*
# Plug-in description that is displayed on some format of menu pages or as context sensitive info
*/
$sPluginDescription = 'Tính toán chiều cao cân nặng theo tiêu chuẩn trung bình'; //'Llogarites i Statistikave Vitale';
