...
$dicom_img_http="uploads/radiology/dicom_img/";
/*
...
*/
$cam_http_1="http://192.168.11.158/view/index.shtml";	// generally remote servers may have any path - this assumes some local ip and filepath
$cam_http_2="$httprotocol://$fotoserver_ip/modules/video_monitor/cam_img/"; // generally remote servers may have any path - this assumes localhost and default folders
$cam_http_3="$httprotocol://$fotoserver_ip/modules/video_monitor/cam_img/"; // generally remote servers may have any path - this assumes localhost and default folders
$cam_http_4="$httprotocol://$fotoserver_ip/modules/video_monitor/cam_img/"; // generally remote servers may have any path - this assumes localhost and default folders
$cam_http_5="";
$cam_http_6="";
$cam_http_7="";
$cam_http_8="";
