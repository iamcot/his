...
=======
            //sửa code
           // case '_DOCHO': $this->sql.="AND (p.to_personell_nr=$val OR a.create_id = '".$_SESSION['sess_login_userid']."')"; break;
        }
...
>>>>>>> Stashed changes
	...
	* @return mixed
	*/
	function getAllByDateObj($y=0,$m=0,$d=0,$user_id){
		return $this->_getAll($y,$m,$d,'_DOCNR',$user_id);
	}
	/**
