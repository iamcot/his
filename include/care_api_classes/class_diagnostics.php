...
class Diagnostics extends Core {
	...
	*/
	...
	var $tb_req_blood_sub='care_test_request_blood_sub';
	/**
	...
	*/
	...
	function useBloodLabRequestTable(){
		$this->setTable($this->tb_req_blood);
		$this->setRefArray($this->blood);
	}
	...
	*/
	...
	function useBloodLabRequestSubTable(){
		$this->setTable($this->tb_req_blood_sub);
		$this->setRefArray($this->blood_sub);
	}
	/**
