...
//                echo($this->sql);
        ...
        function GetPharmaGroupNameSub($group_key){		//id_sub
			global $db;
                if ($group_key=='')
					return false;								
...
//                echo($this->sql);
		...
		function ShowCatalogCabinet($dept_nr, $ward_nr, $current_page, $number_items_per_page, $updown)
        {
            global $db;
			$dept_ward = '';
			if ($dept_nr!='')
...
//			echo $this->sql;
		...
		function ShowKhoChanThuoc_Ton($typedongtayy, $current_page, $number_items_per_page, $condition='', $todate)
        {
			...
			switch($typedongtayy){
				case 'tayy': $tbl_ton =' care_pharma_khochan_ton '; 
							$tbl_ton_info =' care_pharma_khochan_ton_info '; break;	
				case 'dongy': $tbl_ton =' care_pharma_khochan_dongy_ton '; 
							$tbl_ton_info =' care_pharma_khochan_dongy_ton_info '; break;	
			}				
