<?php
$LDDiagnosticTest='Chỉ định xét nghiệm'; //'Diagnostic Test Order';
...
$LDBLoodSugar1='BLS1';
$LDBloodPlasma='BLP';
$LDDoctorSignature='Bác sỹ ký tên'; //'Doctor\'s signature';
$LDLifeRisk='Risk to life';
$LDRarity='Rarity';
$LDSpecTest='Xét nghiệm đặc biệt'; //'special Tests';
$LDClinicalInfo='Thông tin lâm sàng'; //'clinical info';
$LDShortMonth=array('',
                                   'Th.1', //'Jan',
								   'Th.2', //'Feb',
								   'Th.3', //'Mar',
...
$LDMaterial='Material:';
$LDEmergencyProgram='Xét nghiệm có nền màu tím thuộc nhóm xét nghiệm cấp cứu'; //'The violet shaded fields belong to emergency program';
$LDPhoneOrder=' = phải xác nhận bằng điện thoại'; //' = must be confirmed by phone';
/* 2002-09-03 EL */							  
...
/* 2002-09-11 EL */
$LDPendingTestRequest='Yêu cầu đang chờ'; //'Pending Test Request';
/* 2002-10-14 EL */
...
*/
$LD_Elements = array('tx_1'=>'Hóa sinh', //'Clinical Chem.',
                                  'tx_2'=> 'Đông máu', //'Coagulation',
								  'tx_3'=> 'Protein', //'Proteins',
								  'tx_4'=>'Chất đánh dấu khối u', //'Tumormarker',
								  'tx_5'=>'Huyết thanh', //'Infect.serology',
								  'tx_6'=>'Thuốc', //'Medicine',
								  'tx_7'=>'Urine/Spont.u.',
								  ...
								  'tx_11'=>'Tuyến giáp', //'Thyroid glands',
								  '_asma_'=>'ASMA',
								  ...
								  'tx_13'=>'Các yếu tố thấp', //'Rheuma factors',
								 ...
								 'tx_24'=>'Chữ ký bác sỹ', //'Doctor\'s sign',
								 'tx_25'=>'High risk >>',
								 '_highrisk_'=>'<< High risk',
								 'tx_26'=>'Rarity:',
								 'tx_27'=>'Xét nghiệm đặc biệt', //'special Test',
								 'tx_28'=>'',
								 'tx_29'=>'Thông tin lâm sàng' //'clinical info',
								  );
...
$parametergruppe=array(
	'PRIORITY'=>'THƯỜNG QUY', //'PRIORITY',
	'CLINICAL CHEMISTRY'=>'HÓA SINH MÁU', //'CLINICAL CHEMISTRY',
	'LIQUOR'=>'DỊCH NÃO TỦY', //'CSF',
	'COAGULATION'=>'ĐÔNG MÁU', //'COAGULATION',
	'HEMATOLOGY'=>'HUYẾT HỌC', //'HEMATOLOGY',
	'BLOOD SUGAR'=>'ĐƯỜNG HUYẾT', //'BLOOD SUGAR',
	'NEONATE'=>'SƠ SINH', //'NEONATE',
	'PROTEINS'=>'PROTEIN', //'PROTEINS',
	'THYROID'=>'TUYẾN GIÁP', //'THYROID',
	'HORMONES'=>'NỘI TIẾT', //'HORMONES',
	'TUMOR MARKER'=>'CHẤT ĐÁNH DẤU TẾ BÀO KHỐI U', //'TUMOR MARKER',
	'TISSUE ANTIBODY'=>'KHÁNG NGUYÊN MÔ', //'TISSUE ANTIBODY',
	'RHEUMA FACTOR'=>'YẾU TỐ THẤP', //'RHEUMA FACTOR',
	'HEPATITIS'=>'VIÊM GAN', //'HEPATITIS',
	'BIOPSY'=>'SINH THIẾT', //'BIOPSY',
	'INFECTION SEROLOGY'=>'HUYẾT THANH CHẨN ĐOÁN', //'INFECTION SEROLOGY',
	'MEDICINES'=>'THUỐC', //'MEDICINES',
	'PRENATAL'=>'PRENATAL',
	'STOOL'=>'PHÂN', //'STOOL',
	'RARE'=>'XÉT NGHIỆM KHÁC (HIẾM)', //'RARE',
	'URINE'=>'NƯỚC TIỂU', //'URINE',
	'TOTAL URINE'=>'TỔNG PHÂN TÍCH NƯỚC TIỂU', //'TOTAL URINE',
	'SPECIAL'=>'XÉT NGHIỆM ĐẶC BIỆT',
	'BLOOD GAS'=>'XÉT NGHIỆM KHÍ MÁU',
	'PRIORITY URINE'=>'XÉT NGHIỆM NƯỚC TIỂU THƯỜNG QUY',
	'ION'=>'ION ĐỒ',
	'Priority'=>'Thường quy', //'Priority',
	'Clinical chemistry'=>'Hóa sinh máu', //'Clinical chemistry',
	'Liquor'=>'Dịch não tủy', //'CSF',
	...
	$LDParameter='Xét nghiệm'; //'Parameter';
