/* Update quận huyện */
ALTER TABLE care_address_quanhuyen ADD quanhuyen_id NCHAR(10) AFTER NAME;

ALTER TABLE care_address_quanhuyen ADD Quan_Huyen NVARCHAR(10) AFTER quanhuyen_id;

ALTER TABLE care_address_quanhuyen ADD location NCHAR(100) AFTER Quan_Huyen;

DELETE FROM care_address_quanhuyen;

INSERT INTO care_address_quanhuyen (`quanhuyen_id`, `name`, `Quan_Huyen`, `status`, `location`, `citytown_id`) VALUES
('001', 'Ba Đình', 'Quận','normal', '21 02 08N, 105 49 38E', '01'),
('002', 'Hoàn Kiếm', 'Quận','normal', '21 01 53N, 105 51 09E', '01'),
('003', 'Tây Hồ', 'Quận','normal', '21 04 10N, 105 49 07E', '01'),
('004', 'Long Biên', 'Quận','normal', '21 02 21N, 105 53 07E', '01'),
('005', 'Cầu Giấy', 'Quận','normal', '21 01 52N, 105 47 20E', '01'),
('006', 'Đống Đa', 'Quận','normal', '21 00 56N, 105 49 06E', '01'),
('007', 'Hai Bà Trưng', 'Quận','normal', '21 00 27N, 105 51 35E', '01'),
('008', 'Hoàng Mai', 'Quận','normal', '20 58 33N, 105 51 22E', '01'),
('009', 'Thanh Xuân', 'Quận','normal', '20 59 44N, 105 48 56E', '01'),
('016', 'Sóc Sơn', 'Huyện','normal', '21 16 55N, 105 49 46E', '01'),
('017', 'Đông Anh', 'Huyện','normal', '21 08 16N, 105 49 38E', '01'),
('018', 'Gia Lâm', 'Huyện','normal', '21 01 28N, 105 56 54E', '01'),
('019', 'Từ Liêm', 'Huyện','normal', '21 02 39N, 105 45 32E', '01'),
('020', 'Thanh Trì', 'Huyện','normal', '20 56 32N, 105 50 55E', '01'),
('024', 'Hà Giang', 'Thị Xã','normal', '22 46 23N, 105 02 39E', '02'),
('026', 'Đồng Văn', 'Huyện','normal', '23 14 34N, 105 15 48E', '02'),
('027', 'Mèo Vạc', 'Huyện','normal', '23 09 10N, 105 26 38E', '02'),
('028', 'Yên Minh', 'Huyện','normal', '23 04 20N, 105 10 13E', '02'),
('029', 'Quản Bạ', 'Huyện','normal', '23 04 03N, 104 58 05E', '02'),
('030', 'Vị Xuyên', 'Huyện','normal', '22 45 50N, 104 56 26E', '02'),
('031', 'Bắc Mê', 'Huyện','normal', '22 45 48N, 105 16 26E', '02'),
('032', 'Hoàng Su Phì', 'Huyện','normal', '22 41 37N, 104 40 06E', '02'),
('033', 'Xín Mần', 'Huyện','normal', '22 38 05N, 104 28 35E', '02'),
('034', 'Bắc Quang', 'Huyện','normal', '22 23 42N, 104 55 06E', '02'),
('035', 'Quang Bình', 'Huyện','normal', '22 23 07N, 104 37 11E', '02'),
('040', 'Cao Bằng', 'Thị Xã','normal', '22 39 20N, 106 15 20E', '04'),
('042', 'Bảo Lâm', 'Huyện','normal', '22 52 37N, 105 27 28E', '04'),
('043', 'Bảo Lạc', 'Huyện','normal', '22 52 31N, 105 42 41E', '04'),
('044', 'Thông Nông', 'Huyện','normal', '22 49 09N, 105 57 05E', '04'),
('045', 'Hà Quảng', 'Huyện','normal', '22 53 42N, 106 06 32E', '04'),
('046', 'Trà Lĩnh', 'Huyện','normal', '22 48 14N, 106 19 47E', '04'),
('047', 'Trùng Khánh', 'Huyện','normal', '22 49 31N, 106 33 58E', '04'),
('048', 'Hạ Lang', 'Huyện','normal', '22 42 37N, 106 41 42E', '04'),
('049', 'Quảng Uyên', 'Huyện','normal', '22 40 15N, 106 27 42E', '04'),
('050', 'Phục Hoà', 'Huyện','normal', '22 33 52N, 106 30 02E', '04'),
('051', 'Hoà An', 'Huyện','normal', '22 41 20N, 106 02 05E', '04'),
('052', 'Nguyên Bình', 'Huyện','normal', '22 38 52N, 105 57 02E', '04'),
('053', 'Thạch An', 'Huyện','normal', '22 28 51N, 106 19 51E', '04'),
('058', 'Bắc Kạn', 'Thị Xã','normal', '22 08 00N, 105 51 10E', '06'),
('060', 'Pác Nặm', 'Huyện','normal', '22 35 46N, 105 40 25E', '06'),
('061', 'Ba Bể', 'Huyện','normal', '22 23 54N, 105 43 30E', '06'),
('062', 'Ngân Sơn', 'Huyện','normal', '22 25 50N, 106 01 00E', '06'),
('063', 'Bạch Thông', 'Huyện','normal', '22 12 04N, 105 51 01E', '06'),
('064', 'Chợ Đồn', 'Huyện','normal', '22 11 18N, 105 34 43E', '06'),
('065', 'Chợ Mới', 'Huyện','normal', '21 57 56N, 105 51 29E', '06'),
('066', 'Na Rì', 'Huyện','normal', '22 09 48N, 106 05 09E', '06'),
('070', 'Tuyên Quang', 'Thị Xã','normal', '21 49 40N, 105 13 12E', '08'),
('072', 'Nà Hang', 'Huyện','normal', '22 28 34N, 105 21 03E', '08'),
('073', 'Chiêm Hóa', 'Huyện','normal', '22 12 49N, 105 14 32E', '08'),
('074', 'Hàm Yên', 'Huyện','normal', '22 05 46N, 105 00 13E', '08'),
('075', 'Yên Sơn', 'Huyện','normal', '21 51 53N, 105 18 14E', '08'),
('076', 'Sơn Dương', 'Huyện','normal', '21 40 22N, 105 22 57E', '08'),
