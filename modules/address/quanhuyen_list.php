...
$address=&$address_obj->getLimitActiveQuanHuyen($GLOBAL_CONFIG['pagin_address_list_max_block_rows'],$pgx,$oitem,$odir);
...
if(isset($totalcount) && $totalcount){
	...
	$totalcount=$address_obj->countAllActiveQuanHuyen();
	$pagen->setTotalDataCount($totalcount);
}
...
?>
  <tr  class="<?php echo $bgc ?>">
    <td><a href="quanhuyen_info.php<?php echo URL_APPEND.'&retpath=list&nr='.$addr['nr']; ?>"><?php echo $addr['name']; ?></a></td>
    <!-- gjergji added zip code -->
	<?php
	 $sql="SELECT name FROM care_address_citytown WHERE nr='".$addr['citytown_id']."'";
