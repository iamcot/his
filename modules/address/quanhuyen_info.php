...
if(isset($nr) && $nr&&($row=&$address_obj->getQuanHuyenInfo($nr))){
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$LDQuanHuyen :: $LDData");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"$LDQuanHuyen :: $LDData");
...
<table border=0 cellpadding=4 >
  ...
  <tr>
    <td align=right class="adm_item"></font><?php echo $LDQuanHuyenName ?>: </td>
  ...
  <tr>
    <td><a href="quanhuyen_update.php<?php echo URL_APPEND.'&retpath='.$retpath.'&nr='.$address['nr']; ?>"><img <?php echo createLDImgSrc($root_path,'update.gif','0') ?>></a></td>
    <td  align=right><a href="quanhuyen_list.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'list_all.gif','0') ?>></a> <a href="<?php echo $breakfile; ?>"><img <?php echo createLDImgSrc($root_path,'cancel.gif','0') ?>></a></td>
  </tr>
</table>
<p>
