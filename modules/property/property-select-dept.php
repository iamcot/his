...
$dept_DOC=$dept_obj->getAllActive(-1);

switch($target){
	case 'search': $title=$LDFindProperties;
					  $fileforward='property-find-advance.php'.URL_APPEND.'&retpath='.$retpath;
					  break;
	case 'plist': $title=$LDPropertyList;
					  $fileforward='property-list-by-dept.php'.URL_APPEND.'&retpath='.$retpath;
					  break;
	default: $title=$LDPropertyList;
					  $fileforward='property-find-advance.php'.URL_APPEND.'&retpath='.$retpath;
					  break;
}
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$LDPropertyManagement::$title");
