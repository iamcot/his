...
$fpdf= new tFPDF('L','mm',array(100,51));
$fpdf->AddPage();
...
//----------------Tuyen
$fpdf->Ln(10);
$fpdf->Cell(40,5,"PID : ".$encounter [ 'pid' ],0,0,'L');
$fpdf->Cell(40,5,$encounter['name_last'].' '.$encounter [ 'name_first' ],0,1,'L');

$fpdf->Cell(60,5,PDF_HOSNAME,0,1,'L');
//$fpdf->SetLineWidth(0.5);
//$x=$fpdf->GetX()-10;$y=$fpdf->GetY()+2;
//$fpdf->Line($x,$y,$x+80,$y);
//$fpdf->Ln();
# Load the patient data plate #1
//$pataddress = $encounter [ 'addr_str_nr' ] . " " . $encounter [ 'addr_str' ] . "\n" . $encounter [ 'addr_zip' ] . " " . $person_obj->CityTownName ( $encounter [ 'addr_citytown_nr' ] ) ;

//pat data
//$fpdf->Cell(60,5,$LDLastName." : ".$encounter['name_last'],0,1,'L');
//$fpdf->Cell(60,5,$LDFirstName." : ".$encounter [ 'name_first' ],0,1,'L');
//$fpdf->Cell(60,5,$LDBday . " : " . formatDate2Local ( $encounter [ 'date_birth' ], $date_format ),0,1,'L');
//$fpdf->Cell(60,5,"PID : ".$encounter [ 'pid' ],0,1,'L');
//$fpdf->Cell(60,5,$LDAddress." : ",0,1,'L');
//$fpdf->MultiCell(90,5,$pataddress,0,'L');

//$fpdf->SetLineWidth(0.1);
//$x=$fpdf->GetX();$y=$fpdf->GetY()+2;
//$fpdf->Line($x,$y,$x+60,$y);

# Add the PID barcode
if (file_exists ( $pidbarcode )) {
	$imgsize = GetImageSize ( $pidbarcode ) ;
	$fpdf->Image( $pidbarcode, 0, 5, 75, 15 ) ;
	//$fpdf->Image( $pidbarcode, 0, 165, 75, 15 ) ;
}
//$fpdf->Ln(6);

//pat data
//$fpdf->Cell(60,5,$LDRegDate." :",0,1,'L');
//$fpdf->Cell(60,5,formatDate2Local ( $person [ 'date_reg' ], $date_format ) ,0,1,'L');
//$fpdf->Cell(60,5,$LDRegTime . " :",0,1,'L');
//$fpdf->Cell(60,5,formatDate2Local ( $person [ 'date_reg' ], $date_format, TRUE, TRUE )  ,0,1,'L');
//
//$fpdf->Cell(60,5,$LDSex . " : " . $person [ 'sex' ],0,1,'L');
//
//$fpdf->Cell(60,5,$LDBloodGroup . " : " . $person [ 'blood_group' ],0,1,'L');
//
//$x=$fpdf->GetX();$y=$fpdf->GetY()+2;
//$fpdf->Line($x,$y,$x+60,$y);
//$fpdf->Ln(6);
//
//$fpdf->Cell(60,5,$LDInsuranceNr . " :",0,1,'L');
//$fpdf->Cell(60,5,$insurance_nr ,0,1,'L');
//$fpdf->Cell(60,5,$LDInsuranceClass . " :",0,1,'L');
//$fpdf->Cell(60,5,$insclass ,0,1,'L');
//$fpdf->Cell(60,5,$LDInsuranceCo . " :",0,1,'L');
//$fpdf->Cell(60,5,$insurance_firm_name ,0,1,'L');
//
//$fpdf->Cell(60,5,$LDAdmitBy . " :",0,1,'L');
//$fpdf->Cell(60,5,$person [ 'create_id' ],0,1,'L');
