...
$htmlpatient='<table width="100%" cellpadding="1">
	...
	if($encounter['benhphu']!='')	
		$htmlpatient .= '<br>'.$encounter['benhphu'];
...
$htmlnote='<table width="100%" cellpadding="1">
	<tr><td colspan="2" align="right">Tiền thuốc (chưa BHYT): '.number_format($pres_show['total_cost']).'</td></tr>
...
$htmlnote .='+ Khi tái khám nhớ đem theo toa thuốc này hay sổ khám bệnh.</td></tr>';
$htmlnote .='<tr><td colspan=2 width="100%">
