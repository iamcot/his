...
if(!stristr($filter,$nr)){
	...
	$fpdf->Cell(0,5,$LDDate.": ".formatDate2Local($report['date'],$date_format)."  ".$LDTime.": ".$report['time']."  ".$LDBy.": ".$report['personell_name'],0,1,'R');

	$fpdf->Cell(80,5,$LDDepartment.': '.$deptName,0,0,'L',true);
	$fpdf->Cell(0,5,$LDWard.': '.$wardName['name'],0,1,'L',true);
	$fpdf->Cell2Col(60,5,$LDRoom.':',$wardName['roomprefix'].$roomName);
	$fpdf->Cell2Col(60,5,$LDBed.':',$roomNumber);
	$fpdf->Ln(6);
	
	
	$fpdf->Cell(0,5,$LDAllergy . " : " .$patientAllergy . "                    " . $LDDiagnosis . " : " .$patientDiagnosis ,0,1,'L');
	$fpdf->Ln(6);
...
$fpdf->MultiCell(0,5,$prescriptionTable,0,'L');
//$fpdf->MultiCell(0,5,$tableoptions,0,'L');
// make empty line
$fpdf->Ln(14);
//gjergji : added new table to be filled with prices
$fpdf->MultiCell(0,5,$billTable,0,'L');
$fpdf->MultiCell(0,5,$billTableOptions,0,'L');
// make empty line
$fpdf->Ln(14);
$pdf->Cell(0,5,$prescribeDate,0,1,'L');
$fpdf->Cell(60,5,$LDNotes,0,0,'L');
$fpdf->MultiCell(0,5,$prescriptionNotes,0,'L');
$fpdf->Ln(14);
$fpdf->Cell2Col(80,5,$LDDoctor,$LDPharmacist);
$fpdf->Cell(0,5,$presPrescriber,0,1,'L');
$fpdf->Ln(10);
$fpdf->Cell(0,5,"______________________                                        ______________________ ",0,0,'L');
$fpdf->Ln(10);
