...
$fpdf->Ln();
$fpdf->SetFont('','',12);
$fpdf->Cell2Col(60,5,$LDAdmitDate.':',formatDate2Local($encounter['encounter_date'],$date_format));
$fpdf->Cell2Col(60,5,$LDAdmitTime.':',formatDate2Local($encounter['encounter_date'],$date_format,TRUE,TRUE));
$fpdf->Ln();
$fpdf->Cell2Col(60,5,$LDTitle.':',$encounter['title']);
$fpdf->Cell2Col(60,5,$LDSex.':',$encounter['sex']);
$fpdf->Cell2Col(60,5,$LDBloodGroup.':',$encounter['blood_group']);
$fpdf->Cell2Col(60,5,$LDAdmitType.':',$eclass);
if($encounter['encounter_class_nr']==1){
	$fpdf->Cell2Col(60,5,$LDWard.':',$current_ward_name);
}else{
	$fpdf->Cell2Col(60,5,$LDDepartment.':',$current_dept_name);
}

$fpdf->Cell2Col(60,5,$LDDiagnosis.':',$encounter['referrer_diagnosis']);
$fpdf->Cell2Col(60,5,$LDRecBy.':',$encounter['referrer_dr']);
$fpdf->Cell2Col(60,5,$LDTherapy.':',$encounter['referrer_recom_therapy']);
$fpdf->Cell2Col(60,5,$LDSpecials.':',$encounter['referrer_notes']);
$fpdf->Ln();
$fpdf->Cell2Col(60,5,$LDBillType.':',$insclass);
$fpdf->Cell2Col(60,5,$LDInsuranceNr.':',$encounter['insurance_nr']);
$fpdf->Cell2Col(60,5,$LDInsuranceCo.':',$insurance_obj->getFirmName($encounter['insurance_firm_id']));
$fpdf->Ln();
$fpdf->Cell2Col(60,5,$LDAdmitBy.':',$encounter['create_id']);
