...
$continue = 'confirmfinalbill.php'.URL_APPEND.'&patientno='.$patientno.'&full_en='.$full_en.'&target='.$target;
...
//Con lai
$total_resume = $cntbill['total_amount']-$cntbill['total_discount']-$cntbill['total_outstanding']-$payment['sumcost'];     //$cntbill['total_outstanding'] số tiền tính hóa đơn hiện tại thanh toán
$smarty->assign('LDAmountDue',$LDAmountDue);                                                                               //$payment['sumcost'] số tiền tạm ứng
