<?php
    ...
    $obj = new Obstetrics;
    $report= $obj->Report_BM07($month,$year);
...
$tbl.='     </tr>
            <tr>
                ...
                <td align="center">'.$info_report['tongphunu'].'</td>
                <td align="center">'.$info_report['khamphukhoa'].'</td>
                <td align="center">'.$info_report['chuaphukhoa'].'</td>
                <td align="center">'.$info_report['naothai'].'</td>
                <td align="center">'.$info_report['hutthai'].'</td>
                <td align="center">0</td>
                <td align="center">'.$info_report['trevtnphathai'].'</td>
                <td align="center">'.$info_report['mactaibien'].'</td>
                <td align="center">'.$info_report['chettaibien'].'</td>
            </tr>';
            for($i=1;$i<7;$i++){ 
                    $tbl.='<tr>';
                    for($j=1;$j<12;$j++){
