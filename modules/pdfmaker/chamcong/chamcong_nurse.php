...
$doctors=$pers_obj->getNursesOfDept($dept_nr);
...
$fpdf->Cell(0,7,'BẢNG CHẤM CÔNG ĐIỀU DƯỠNG',0,0,'C');
$fpdf->Ln(); 
$fpdf->SetFont('DejaVu','B',12);
...
$fpdf->SetY($temp);
$temp=$temp+6;
$fpdf->Cell(55,5,"  ".$count."     ".$content[$j]['name_last']." ".$content[$j]['name_first'],0,0,'L');
