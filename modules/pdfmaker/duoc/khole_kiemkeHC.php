...
$listItem = $Product->ShowCatalogChemicalKhoLe('', '', $cond_typeput);
...
$pdf->SetAuthor($cell);
$pdf->SetTitle('Kiểm kê hóa chất kho lẻ');
...
$header='<table width="100%">
		<tr>
			...
			<td valign="top" align="center" width="400">
				<font size="15"><b>BIÊN BẢN KIỂM KÊ HÓA CHẤT'.$titlereport.'</b></font>
			</td>
...
$html='	<table cellpadding="2" border="1">
			<tr>
				...
				<td rowspan="2" align="center" width="250"><b>Tên hóa chất, quy cách đóng gói</b></td>
...
$pdf->Output('KhoLe_KiemkeHC.pdf', 'I');
