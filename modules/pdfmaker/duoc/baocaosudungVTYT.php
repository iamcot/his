...
$listReport = $Cabinet->reportMonth($dept_nr,$ward_nr,$monthreport,$yearreport);
...
$header='<table width="100%">
		<tr>
			...
			<td valign="top" align="center" width="400">
				<font size="15"><b>BÁO CÁO SỬ DỤNG VẬT TƯ Y TẾ TIÊU HAO</b></font>
			</td>
...
$pdf->Output('BaocaosudungVTYT.pdf', 'I');
