...
switch($select_type){	
	case 0: $cond_typeput = ''; 
			$titlereport=''; break;
	case 1: $cond_typeput = ' AND khole.typeput=1 ';
			$titlereport=' KINH PHÍ '; break;
	case 2: $cond_typeput = ' AND khole.typeput=0 ';
			$titlereport=' BHYT '; break;
	case 3: $cond_typeput = ' AND khole.typeput=2 '; 
			$titlereport=' CBTC '; break;			
	default: $cond_typeput = '';
			$titlereport=''; break;
}

$listItem = $Product->ShowCatalogMedipotKhoLe('', '', $cond_typeput);
...
$pdf->SetAuthor($cell);
$pdf->SetTitle('Kiểm kê VTYT kho lẻ');
...
$header='<table width="100%">
		<tr>
			<td valign="top" width="200">
				Bộ Y Tế (Sở Y Tế):..............<br>
				BV: '.$cell.'<br>
				Khoa: Khoa Dược - Kho Lẻ
			</td>
			<td valign="top" align="center" width="400">
				<font size="15"><b>BIÊN BẢN KIỂM KÊ VẬT TƯ Y TẾ TIÊU HAO'.$titlereport.'</b></font>
			</td>
...
$html='	<table cellpadding="2" border="1">
			<tr>
				...
				<td rowspan="2" align="center" width="250"><b>Tên vật tư y tế tiêu hao</b></td>
...
$congkhoan = 0;
	if(is_object($listItem)){
		...
		for ($i=0;$i<$listItem->RecordCount();$i++)
		{
			...
			$congkhoan += $rowItem['price']*$rowItem['available_number'];
...
$pdf->Output('KhoLe_KiemkeVTYT.pdf', 'I');
