...
switch($select_type){	
	case 0: $listReport = $Cabinet->reportMedipotMonth($monthreport,$yearreport); 
			$titlereport=''; break;
	case 1: $listReport = $Cabinet->reportMedipotKPMonth($monthreport,$yearreport); 
			$titlereport=' KINH PHÍ '; break;
	case 2: $listReport = $Cabinet->reportMedipotBHMonth($monthreport,$yearreport); 
			$titlereport=' BHYT '; break;
	case 3: $listReport = $Cabinet->reportMedipotCBTCMonth($monthreport,$yearreport); 
			$titlereport=' CBTC '; break;			
	default: $listReport = $Cabinet->reportMedipotMonth($monthreport,$yearreport);
			$titlereport=''; 
}
...
$pdf->SetAuthor($cell);
$pdf->SetTitle('Báo Cáo Sử Dụng VTYT');
...
$header='<table width="100%">
		<tr>
			...
			<td valign="top" align="center" width="400">
				<font size="15"><b>BÁO CÁO SỬ DỤNG VẬT TƯ Y TẾ TIÊU HAO'.$titlereport.'</b></font>
			</td>
	...
	//Load tieu de bang
		$html='	<table cellpadding="2" border="1">
					<tr>
						...
						<td align="center" rowspan="2" width="160"><b>Tên vật tư y tế tiêu hao</b></td>
