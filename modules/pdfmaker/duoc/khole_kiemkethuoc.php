...
$listItem = $Product->ShowCatalogKhoLe('', '', $cond_typeput);
...
$pdf->SetAuthor($cell);
$pdf->SetTitle('Kiểm kê thuốc kho lẻ');
...
$html='	<table cellpadding="2" border="1">
			<tr>
				...
				<td rowspan="2" align="center" width="250"><b>Tên thuốc, nồng độ, hàm lượng</b></td>
...
$html= $html.'<tr>
				...
				<td align="right"><b></b></td><td></td><td></td>
			</tr>
		</table>';
...
$pdf->Output('KhoLe_Kiemkethuoc.pdf', 'I');
