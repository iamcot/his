...
$Product=new Product();
	...
	switch($dongtayy){
		case 'tayy': $dongtayy_cond = ' AND khochan.pharma_type IN (1,2,3) ';
			$title1=$LDthuocTayY; break;
		case 'dongy': $dongtayy_cond = ' AND khochan.pharma_type IN (4,8,9,10) '; 
			$title1=$LDthuocDongY; break;
		default: $dongtayy_cond = ''; $title1=$LDthuoc; break;
	}	
	
//$listItem = $Product->ShowKhoChanThuoc_Ton($dongtayy_cond, '', '', $cond_typeput, $todate);
$listItem =$Product->ShowKhoChanThuoc_Ton($dongtayy, '', '', '', $todate);
...
$html='	<table cellpadding="2" border="1">
			<tr>
				...
				<td rowspan="2" align="center" width="225"><b>Tên thuốc, nồng độ, hàm lượng</b></td>
				...
				<td rowspan="2" align="center" width="75"><b>Nước sản xuất</b></td>
				<td rowspan="2" align="center" ><b>Hạn dùng</b></td>
				<td colspan="2" align="center" width="100"><b>Số lượng</b></td>
				<td rowspan="2" align="center" width="40"><b>Hỏng vỡ</b></td>
				<td rowspan="2" align="center" width="80"><b>TT</b></td>
			</tr>
			<tr>
	...
	if(is_object($listItem)){
		...
		for ($i=0;$i<$listItem->RecordCount();$i++)
		{
			...
			$sTemp=$sTemp.'<tr>
								...
								<td align="center"></td>
								<td align="center"></td>
								<td align="right">'.number_format($rowItem['number']*$rowItem['price']).'</td>
							</tr>';
		}			
	}else{
...
$html= $html.$sTemp;
$html= $html.'<tr>
				<td></td><td><b></b></td><td></td><td></td><td></td><td></td><td></td><td></td>
				<td align="right"></td><td></td><td align="right"><b>'.number_format($congkhoan).'</b></td>
			</tr>
		</table>';
