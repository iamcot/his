...
if($result_info = $Pharma->getInfoChemical($encoder)){
	$medicine_name = $result_info['product_name'];		//Ten vtyt
	$medicine_unit = $result_info['unit_name_of_chemical'];	//Don vi
	$medicine_content = '';	//Nong do hoa chat
}
	
//Ton kho gan nhat (x1) truoc ngay fromdate 
$result_ton = $Pharma->Khochan_hoachat_tontruoc($encoder, $cond_typeput." AND toninfo.todate<'$fromdate' ");	
	if($result_ton!=false){
