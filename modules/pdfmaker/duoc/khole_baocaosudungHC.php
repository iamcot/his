...
switch($select_type){	
	case 0: $listReport = $Cabinet->reportChemicalMonth('','',$monthreport,$yearreport); 
			$titlereport=''; break;
	case 1: $listReport = $Cabinet->reportChemicalKPMonth($monthreport,$yearreport); 
			$titlereport=' KINH PHÍ '; break;
	case 2: $listReport = $Cabinet->reportChemicalBHMonth($monthreport,$yearreport);
			$titlereport=' BHYT '; break;
	case 3: $listReport = $Cabinet->reportChemicalCBTCMonth($monthreport,$yearreport);
			$titlereport=' CBTC '; break;			
	default: $listReport = $Cabinet->reportChemicalMonth('','',$monthreport,$yearreport); 
			$titlereport=''; break;
}
