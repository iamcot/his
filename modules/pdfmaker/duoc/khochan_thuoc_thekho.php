...
if($result_info = $Pharma->getInfoMedicine($encoder)){
	$medicine_name = $result_info['product_name'];		//Ten thuoc
	$medicine_unit = $result_info['unit_name_of_medicine'];	//Don vi
	$medicine_content = $result_info['content'];	//Ham luong
}
	
//Ton kho gan nhat (x1) truoc ngay fromdate 
$result_ton = $Pharma->Khochan_thuoc_tontruoc($encoder, $cond_typeput." AND toninfo.todate<'$fromdate' ");	
	if($result_ton!=false){
