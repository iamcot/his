...
switch($target)
{
	case 'dutyplan': $fileforward="doctors-dienstplan-planen.php".URL_REDIRECT_APPEND."&dept_nr=$dept_nr&retpath=$retpath&pmonth=$pmonth&pyear=$pyear";
							...
							break;
	case 'chamcong': $fileforward="doctors-dienstplan-planen-chamcong.php".URL_REDIRECT_APPEND."&dept_nr=$dept_nr&retpath=$retpath&pmonth=$pmonth&pyear=$pyear";
							$title=$LDDOCScheduler;
							break;
	case 'luong': $fileforward="dienstplan-planen-luong.php".URL_REDIRECT_APPEND."&dept_nr=$dept_nr&retpath=$retpath&pmonth=$pmonth&pyear=$pyear";
							$title=$LDLuong;
							break;
