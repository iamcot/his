...
<script language="javascript">
 ...
 function printOut()
    {
            urlholder="<?php echo $root_path ?>modules/pdfmaker/chamcong/chamcong.php<?php echo URL_APPEND ?>&dept_nr=<?php echo $dept_nr ?>&pmonth=<?php echo $pmonth ?>&pyear=<?php echo $pyear ?>";
...
if(($n<=6)&& ($n!=$pday)){$class="week1";}
	...
	if($relems['r'.$j.'_'.$n]==1){$rtem='X';}
	elseif($relems['r'.$j.'_'.$n]==2){$rtem='CT';}
	elseif($relems['r'.$j.'_'.$n]==3){$rtem='TR';}
	elseif($relems['r'.$j.'_'.$n]==4){$rtem='NG';}
	elseif($relems['r'.$j.'_'.$n]==5){$rtem='P';}
	elseif($relems['r'.$j.'_'.$n]==6){$rtem='B';}
	elseif($relems['r'.$j.'_'.$n]==7){$rtem='HS';}
	elseif($relems['r'.$j.'_'.$n]==8){$rtem='NK';}
	elseif($relems['r'.$j.'_'.$n]==9){$rtem='KL';}
	elseif($relems['r'.$j.'_'.$n]==10){$rtem='DH';}
	elseif($relems['r'.$j.'_'.$n]==0){$rtem=' ';}
echo '<td class="'.$class.'">		
				Sáng '.$atem.'
				Chiều '.$rtem.'
			</td>';		
...
?>
	   ...
	   <td valign="top">
        <a href="doctors-main-pass.php<?php echo URL_APPEND ?>&target=chamcong&dept_nr=<?php echo$dept_nr?>&pmonth=<?php echo$pmonth?>&pyear=<?php echo$pyear?>&retpath=<?php echo$retpath?>"><img <?php echo createLDImgSrc($root_path ,'newplan.gif','0') ?>  alt="<?php echo$LDNewPlan;?>"></a>
		<p>
		<a href="<?php echo $rettarget ;?>"><img <?php echo createLDImgSrc($root_path,'close2.gif','0') ?> alt="<?php echo $LDClosePlan?>"></a>
      </td>
	  </tr>
    <tr>
      <td colspan="3">        <a href="doctors-main-pass.php<?php echo URL_APPEND ?>&target=chamcong&dept_nr=<?php echo$dept_nr?>&pmonth=<?php echo$pmonth?>&pyear=<?php echo$pyear?>&retpath=<?php echo$retpath?>"><img <?php echo createLDImgSrc($root_path ,'newplan.gif','0') ?>  alt="<?php echo$LDNewPlan;?>"></a>
...
$smarty->assign('sNewPlan',"<a href=\"doctors-main-pass.php".URL_APPEND."&target=chamcong&dept_nr=$dept_nr&pmonth=$pmonth&pyear=$pyear&retpath=$retpath\"><img ".createLDImgSrc($root_path,'newplan.gif','0')."  alt=\"$LDNewPlan\"></a>");
