...
<select name="job_post" style="width:83%;">
	<option value="0">Không</option>
	<?php
	$job_type=$personell_obj->getTypeChucVu();
...
<td colspan=2 class="adm_input"><input name="salary_grading" type="text" size="30"  value="<?php echo $salary_grading; ?>" >
</td>
</tr>
<tr>
<td class="adm_item"><?php echo $LDHeSoChucVu ?>:
</td>
<td colspan=2 class="adm_input"><input name="heso_chucvu" type="text" size="30"  value="<?php echo $heso_chucvu; ?>" >
</td>
</tr>
<tr>
<td class="adm_item"><?php echo $LDHeSoDocHai ?>:
</td>
<td colspan=2 class="adm_input"><input name="heso_dochai" type="text" size="30"  value="<?php echo $heso_dochai; ?>" >
</td>
</tr>
<!-- -->
<tr>
