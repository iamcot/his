...
switch($mode){
	case 'ward': 
				...
				break;
	case 'issue':
				$fileforward="nursing-issuepaper-selectward.php".URL_REDIRECT_APPEND;
				break;
...
<img <?php echo createComIcon($root_path,'wheelchair.gif','0','top') ?> valign="middle" >
<FONT  COLOR="#5f88be"  SIZE=5  FACE="verdana"> <b><?php echo "$LDNursingStation ".":: ".stripslashes($station); ?></b></font>
