...
$maxelement=10;
	...
	if($mode=='save'){
		...
		$data_array['unit_nr']=19; // 19 = L/ph unit of measurement , must be set to local standards
		...
		for($i=0;$i<$maxelement;$i++)
		{
			...
			$data_array['msr_time']=strtr($$tdx,'.,;-/_','::::::').':00';
		...
		$bpcount=0;
		$tempcount=0;
		$chart_bp=$charts_obj->getDayMach($pn,date('Y-m-d',mktime(0,0,0,$mo,$dy,$yr)));		
...
?>
  ...
  <tr>
    <td  align=center bgcolor="#cfcfcf" class="v13"><font color="#ff0000"><?php echo $LDMach ?></td>
    ...
    <td align=center bgcolor="#ffffff">
		...
		<table border=0 border=0 cellspacing=0 cellpadding=0>
			<tr>
   			 ...
   			 <td  align=center class="v12"><?php echo $LDMach ?>:</td>
		  </tr>
			<?php 
			...
			for($i=0;$i<$maxelement;$i++)
			{
				...
				echo '
						...
						$(function(){
   						 ...
   						 <td class="v12"><input type="text" name="bdata'.$i.'" size=8 maxlength=7 value="" onBlur="checkNumberItem(this)">  L/ph'.$GLOBAL_CONFIG['measure_bp_unit_id'].'</td>
  						</tr>
 						 ';
				}
 			?>
    ...
    <td align=center bgcolor="#ffffff">
		...
		<table border=0 border=0 cellspacing=0 cellpadding=0>
			...
			for($i=0;$i<$maxelement;$i++)
			{
				...
				echo '
 						 <tr>
   						 <td><input type="text" id="ttime'.$i.'" name="ttime'.$i.'" size=6 maxlength=5 value="'.$tempvalue.'" onBlur="checkTime(this)">
						<script language="javascript">
						$(function(){
							$("#ttime'.$i.'").mask("**:**");
						});
   						 ...
   						 <td class="v12"><input type="text" name="tdata'.$i.'" size=8 maxlength=7 value="" onBlur="checkNumberItem(this)"> C'.$GLOBAL_CONFIG['measure_temp_unit_id'].'</td>
  						</tr>
  						';
			}
 			?>
