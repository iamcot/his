 ...
 */
 ...
 if($rows) {  
   ...
   */
   ...
   echo '
        <td align=center><a href="javascript:statbel(\'1\',\''.$result['nr'].'\',\''.'ward_id'.'\')"  title="'.$LDClk2Show.'">';
   ...
   echo '
        <td align="center">';
	if($is_today){
		echo '<a href="javascript:statbel(\'1\',\''.$result['nr'].'\',\''.'ward_id'.'\')" title="'.str_replace("~station~",$result['name'],$LDEditStation).'" >';
	}
   if(defined('USE_PIE_CHART')&&USE_PIE_CHART){
	...
	if($is_today){
		echo '
			<a href="javascript:statbel(\'1\',\''.$result['nr'].'\',\''.'ward_id'.'\')" title="'.str_replace("~station~",$result['name'],$LDEditStation).'" >
