...
if($edit){
 ...
 $tpbuffer='<input type="radio" name="material_type" value="pe_la"';
 if($mode=="edit" && $stored_request['material_type']=="pe_la") $tpbuffer.= "checked";
 $smarty->assign('input_material_type_pe_la',$tpbuffer.'>');
 $smarty->assign('LDPE',$LDPE);
  $tpbuffer='<input type="radio" name="material_type" value="pe_no"';
 if($mode=="edit" && $stored_request['material_type']=="pe_no") $tpbuffer.= "checked";
 $smarty->assign('input_material_type_pe_no',$tpbuffer.'>');
 $smarty->assign('LDNo',$LDNo);
  $tpbuffer='<input type="radio" name="material_type" value="pe_th"';
 if($mode=="edit" && $stored_request['material_type']=="pe_th") $tpbuffer.= "checked";
 $smarty->assign('input_material_type_pe_th',$tpbuffer.'>');
 $smarty->assign('LDTh',$LDTh);
  $smarty->assign('LDLa',$LDLa);
 ...
 $tpbuffer='<input type="radio" name="material_type" value="cytology_th"';
 if($mode=="edit" && $stored_request['material_type']=="cytology_th") $tpbuffer.= " checked";
 $smarty->assign('input_material_type_cytology_th',$tpbuffer.'>');
 $smarty->assign('LDCytologyTh',$LDCytologyTh);
 
 $tpbuffer='<input type="radio" name="material_type" value="cytology_sa"';
 if($mode=="edit" && $stored_request['material_type']=="cytology_sa") $tpbuffer.= " checked";
 $smarty->assign('input_material_type_cytology_sa',$tpbuffer.'>');
 $smarty->assign('LDCytologySa',$LDCytologySa);
 
 $tpbuffer='<input type="radio" name="material_type" value="cytology_la"';
 if($mode=="edit" && $stored_request['material_type']=="cytology_la") $tpbuffer.= " checked";
 $smarty->assign('input_material_type_cytology_la',$tpbuffer.'>');
 $smarty->assign('LDCytologyLa',$LDCytologyLa);
