...
function printOut()
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/phieutralaithuoc.php<?php echo URL_APPEND; ?>&report_id=<?php echo $report_id; ?>&type=chemical";
...
<?php
    ...
    $report_show = $Cabinet->getReturnChemicalInfo($report_id);
    $chemical_in_pres = $Cabinet->getDetailChemicalReturnInfo($report_id);
