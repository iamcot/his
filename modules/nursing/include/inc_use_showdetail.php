...
$report_show = $Cabinet->getUseInfo($report_id);
$medicine_in_pres = $Cabinet->getDetailUseInfo($report_id);
...
?>
	...
	<table border=0 cellpadding=3 width="98%">
		<tr><td colspan="4" align="center"><b> <?php echo $LDKeKhaiThuocTrongNgay; ?> </b> <br> &nbsp; </td></tr>
		<tr bgcolor="#f6f6f6">
