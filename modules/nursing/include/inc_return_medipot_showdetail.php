...
function printOut()
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/phieutralaithuoc.php<?php echo URL_APPEND; ?>&report_id=<?php echo $report_id; ?>&type=medipot";
...
?>
	...
	<table border=0 cellpadding=3 width="98%">
		<tr><td colspan="4" align="center"><b> <?php echo $LDReturnMedipot; ?> </b> <br> &nbsp; </td></tr>
		<tr bgcolor="#f6f6f6">
