...
function printOut()
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/phieulinhVTYT.php<?php echo URL_APPEND; ?>&report_id=<?php echo $issue_id; ?>&type=medipot";
...
<?php
if(!isset($IssuePaper)) $IssuePaper = new IssueMedipot;

$issue_show = $IssuePaper->getIssuePaperInfo($issue_id);
$medicine_in_pres = $IssuePaper->getAllMedipotInIssuePaper($issue_id);
...
?>
	...
	<table border=0 cellpadding=3 width="98%">
		<tr><td colspan="4" align="center"><b> <?php echo $LDIssueMedipot; ?> </b> <br> &nbsp; </td></tr>
		<tr bgcolor="#f6f6f6">
			<td width="20%"><FONT SIZE=-1  color="#000066"><?php echo $LDIssueId; ?></td>
			<td width="35%"><FONT SIZE=-1  ><?php echo $issue_id; ?></td>
			<td width="15%"><FONT SIZE=-1  color="#000066"><?php echo $LDGotMedipot; ?></td>
