...
$sql="SELECT care_pharma_products_main.product_encoder, care_pharma_products_main.product_name, sum(care_pharma_products_main_sub.pcs) AS pharma
    FROM care_pharma_products_main
    INNER JOIN care_pharma_products_main_sub 
	ON (care_pharma_products_main.bestellnum =care_pharma_products_main_sub.bestellnum)
