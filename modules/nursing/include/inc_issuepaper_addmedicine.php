<?php
	...
	echo '<tr bgColor="#ffffff" >
		<td width="118" height="20" align="center" bgColor="#ffffff"><input id="encoder'.$i.'" name="encoder'.$i.'" type="text" value="'.$rowIssue['product_encoder'].'" style="text-align:center;border-color:white;border-style:solid;" readonly size="10"><input type="hidden" name="available_product_id' . $i . '" value="' . $rowIssue['available_product_id'] . '"></td>
