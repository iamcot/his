...
require_once($root_path.'include/core/inc_front_chain_lang.php');
	...
	$sql="SELECT med.product_encoder, med.product_name, SUM(khole.available_number) AS available_number, khole.product_lot_id, khole.typeput, 
		...
		".$condition." 
		AND med.in_use='1' 
		GROUP BY med.product_encoder, khole.product_lot_id
		UNION
		SELECT med.product_encoder, med.product_name, SUM(khole.available_number) AS available_number, khole.product_lot_id, khole.typeput,
				ger.generic_drug, grp.pharma_group_name, sup.supplier, sup.supplier_name
	...
	if($ergebnis=$db->Execute($sql))
	{
		echo '<tr align="center">
				<td width="5%"><font color="#5f88be"><b>'.$LDMedicineID1.'</b></td>
