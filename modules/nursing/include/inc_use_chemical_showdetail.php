...
function printOut()
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/phieutralaithuoc.php<?php echo URL_APPEND; ?>&report_id=<?php echo $report_id; ?>&type=medicine";
	testprintpdf=window.open(urlholder,"PhieuSuCungThuocChoKhoa","width=1000,height=760,menubar=yes,resizable=yes,scrollbars=yes");
...
$report_show = $Cabinet->getUseChemicalInfo($report_id);
$medicine_in_pres = $Cabinet->getDetailUseChemicalInfo($report_id);
...
$date1 = formatDate2Local($report_show['date_time_use'],'dd/mm/yyyy');
$time1 = substr($report_show['date_time_use'],-8);
...
?>
	...
	<table border=0 cellpadding=3 width="98%">
		<tr><td colspan="4" align="center"><b> <?php echo $LDKeKhaiHCTrongNgay; ?> </b> <br> &nbsp; </td></tr>
		<tr bgcolor="#f6f6f6">
	   	...
	   	<tr bgcolor="#f6f6f6">
			...
			<td width="15%"><FONT SIZE=-1  color="#000066"><?php echo $LDDay;  ?></td>
	   	...
	   	<tr bgcolor="#f6f6f6">
			...
			<td><FONT SIZE=-1  ><?php echo $report_show['nurse']; ?></td>
	   </tr>
		<tr bgcolor="#f6f6f6">
			...
			<td colspan="4" align="center"><br>
				<table bgcolor="#EEEEEE" width="100%" cellpadding="3">
					<tr bgColor="#E1E1E1" >
						...
						<td width="12%" align="center"><u><?php echo $LDSodangki ?></u></td>
