...
<ul>
 ...
 ?>
  ...
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0"><b><?php echo $LDAnamnesiFamiliare ?></b></li>
    <li class="TabbedPanelsTab" tabindex="0"><b>Anamnesi socio-ambientale</b></li>
    <li class="TabbedPanelsTab" tabindex="0"><b><?php echo AnamnesiFisiologica?></b></li>
  ...
  <form method="post" name=remform action="nursing-yellow-paper.php" onSubmit="return checkForm(this)">
    ...
    <br>
    <b><?php echo $LDStatoAttuale;?></b><br>
    <table>
      <tr>
        <td><i>Altezza:&nbsp;</i></td>
