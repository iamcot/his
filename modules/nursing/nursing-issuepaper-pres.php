...
$fileforward='nursing-issuepaper-depot.php'.URL_APPEND.'&target=sum';
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDIssuePaper.' :: '.$LDPrescriptionTab);
...
if($target=='pres') 
{
	...
	if($listpres=$db->Execute($sql))
	{
		...
		if($count){
			...
			$sListRows='<tr bgColor="#eeeeee"><td colspan="7">'.$LDNoPres.'</td></tr>';
		}
		$itemcode=$itemcode1;
