...
switch ($winid)
    {
    case "diag_ther_dailyreport":			//ghi chu
        $title        =$LDNotes.' 4.';
...
<script language = "javascript">
	...
	function updateitem(nr){
		urlholder="update_ghichu.php?nr="+nr+"<?php echo "&sid=$sid&lang=$lang&edit=$edit&station=$station&pn=$pn"; ?>";
...
<BODY bgcolor = "#99ccff"
    ...
    <table border = 0 width = "100%">
        <tr>
            <td><b><font face = "verdana,arial" size ="4" color = maroon>

                <?php
                echo $title . '<br><font size=3>';
    ...
    <form name = "infoform" action = "<?php echo $thisfile ?>" method = "post" onSubmit = "return pruf(this)">
        ...
        ?>
            ...
            <table border = 0 cellpadding = 4 cellspacing = 1 width = 100%>
                <tr bgcolor = "#f6f6f6" align="center">
                    ...
                    <td <?php echo $tbg; ?>><FONT SIZE = -1 FACE = "Arial" color = "#000066"><?php echo $LDCurrentEntry1; ?></td>
            ...
            ?>
                    ...
                    ?></td>
					<td align="right"><?php echo '<a href="javascript:updateitem(\''.$row['nr'].'\')"><img '.createComIcon($root_path,'pencil.gif','0').' title="'.$LDUpdate.'" ></a>'; ?></td>
                    </tr>
        ...
        ?>
            ...
            <textarea cols = "30" rows = "5" name = "notes" wrap = "physical"><?php echo $notes ?></textarea>
