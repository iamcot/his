...
<table border=0>
 ...
 <table border=0 cellpadding=4 cellspacing=1 width=100%>
	...
	<tr>
    <td colspan=3 bgcolor="#f6f6f6"><?php 	echo $LDTransferToBed.' ('.$station.')'; ?></td>
    <td bgcolor="#f6f6f6">
...
<tr>
  ...
  <tr bgcolor="#f6f6f6">
    <td colspan=4><?php echo $LDTransferToWard; ?></td>
  </tr>
...
while($ward=$ward_info->FetchRow()){
	...
	echo '<tr bgcolor="#f6f6f6"><td>'.$ward['ward_id'].'</td>
	 <td> '.$ward['name'].'</td><td>'.((isset($$ward['LD_var'])&&($$ward['LD_var']!=""))?($$ward['LD_var']):($ward['dept_name'])).'</td>
