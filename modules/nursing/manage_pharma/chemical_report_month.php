<?php
    ...
    */
    ...
    $smarty->assign('sToolbarTitle',$LDUseChemicalReport.' :: '.$LDChemicalReport);
...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/baocaosudungHC.php<?php echo URL_APPEND; ?>&type=chemical&dept_nr="+dept+"&ward_nr="+ward+"&monthreport="+month+"&yearreport="+year;
...
<?php
    ...
    $listReport = $CabinetPharma->reportChemicalMonth($dept_nr,$ward_nr,$monthreport,$yearreport);
	...
	while($rowReport = $listReport->FetchRow())	{
		...
		if ($flag){
                    ...
                    echo	'<td>'.$rowReport['product_encoder'].'</td>';	//Ma hoa chat
