...
function searchItem(){
	...
	xmlhttp.open("GET","cabinet_search_medicine_getdb.php?dept_nr=<?php echo $dept_nr; ?>&ward_nr=<?php echo $ward_nr; ?>&name_med="+name_med+"&name_ger_med="+name_ger_med+"&group_med="+group_med+"&supplier="+supplier,true);
