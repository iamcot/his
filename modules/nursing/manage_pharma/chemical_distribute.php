<?php
    ...
    $breakfile='chemical_distribute_chemical.php'.URL_APPEND.'&dept_nr='.$dept_nr.'&ward_nr=';
    $fileforward= 'chemical_distribute_save.php'.URL_APPEND.'&dept_nr='.$dept_nr.'&ward_nr=';
    ...
    */
    ...
    $smarty->assign('sToolbarTitle',$LDDistributeChemical);

//    # href for help button
//    $smarty->assign('pbHelp',"javascript:gethelp('submenu1.php','$LDDistributeChemical')");

    # Window bar title
    $smarty->assign('title',$LDDistributeChemical);
    ...
    <center>
        ...
        <table border="0" cellSpacing="1" cellPadding="3" width="95%" bgColor="#C3C3C3">
            <tr bgColor="#EDF1F4">
                ...
                <th>
                    <?php echo $LDChemicalID; ?>
                </th>
                <th>
                    <?php echo $LDChemicalName1; ?>
                </th>
                <th>
                    <?php echo $LDUnit; ?>
                </th>	
...
//                            echo $list_wardnr[$i].'aa';
            ...
            <?php 
                ...
                reset($list_wardnr);
                for ($j=1;$j<=$maxid;$j++){
                    $rowItem = $CabinetPharma->getInfoChemicalInAvaiDept($listid[$j]);
                    if($rowItem){ 
                        ...
                        if($number_ward)
                            for ($i=0;$i<$number_ward;$i++)
                                $sTemp=$sTemp.'<td align="center"><input type="text" name="chemical['.$rowItem['available_product_id'].'_'.$list_wardnr[$i].']" id="item'.$j.'_'.$i.'" size="2" value="0" onBlur="CheckValue('.$j.')" /></td>';			
                        $sTemp=$sTemp.'</tr>';
                    }
                }
                echo $sTemp;
        ...
        <table border="0" cellpadding="3" cellspacing="1" width="90%">
            ...
            <tr>
                <td align="center">
                    &nbsp;<br/>
                    <img <?php echo createLDImgSrc($root_path,'done.gif','0','middle'); ?> OnClick="SaveValue()">
                    <br/>&nbsp;
                </td>
            </tr>
        </table>
