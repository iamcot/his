<?php
    ...
    $fileforward= 'chemical_distribute.php'.URL_APPEND.'&dept_nr='.$dept_nr.'&ward_nr='.$ward_nr;
...
//    $smarty->assign('pbHelp',"javascript:gethelp('submenu1.php','$LDDistributeChemical')");
    ...
    # Window bar title
    $smarty->assign('Name',$LDDistributeChemical);
    ...
    <center>
        ...
        <table border="0" cellSpacing="1" cellPadding="3" width="95%" bgColor="#C3C3C3">
            <tr bgColor="#EDF1F4">
                ...
                if ($search==''){
                    ...
                    if ($listItem = $CabinetPharma->SearchDistributeChemicalCabinet($dept_nr, $condition)){		
                    ...
                    if ($total_pages>1)
                        $listItem = $CabinetPharma->ShowDistributeChemicalCabinet($dept_nr, $current_page, $number_items_per_page);
                    ...
                    $listItem = $CabinetPharma->SearchDistributeChemicalCabinet($dept_nr, $condition);
        ...
        <table border="0" cellpadding="3" cellspacing="1" width="90%">
                ...
                <tr>
                    <td align="center">
                        &nbsp;<br/>
                        <img <?php echo createLDImgSrc($root_path,'distribute.gif','0','middle'); ?> OnClick="sendItem()">
                        <br/>&nbsp;
                    </td>
                </tr>
        </table>
