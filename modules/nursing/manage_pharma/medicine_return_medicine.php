...
$fileforward='../include/inc_return_save.php'.URL_APPEND;
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDReturnMedicine.' :: '.$LDNewReportTab);
 ...
 # Window bar title
 $smarty->assign('title',$LDReturnMedicine);
...
<!--
function chkform(d) {
	document.newreturnform.action="../include/inc_return_save.php";
...
{
	var win = 'cabinet_search_medicine.php?id_number='+id_number+'&dept_nr=<?php echo $dept_nr;?>&ward_nr=<?php echo $ward_nr;?>';
...
function Medicine_AutoComplete(i){
			...
			var includeScript = "../include/inc_pharma_cabinet_autocomplete_medicine.php?mode=auto&dept_nr=<?php echo $dept_nr;?>&ward_nr=<?php echo $ward_nr;?>&k="+i;
...
{
	var process_file='../include/inc_pharma_cabinet_autocomplete_medicine.php?mode=filldata&dept_nr=<?php echo $dept_nr;?>&ward_nr=<?php echo $ward_nr;?>';
	var name_med='medicine'+i;
...
$list_report_url='medicine_return_medicine_list.php';
ob_start();
...
$smarty->assign('titleForm',$LDReturnMedicine);
...
if(!isset($target) || ($target=='new') || ($target=='create')){
		...
		$listReport = $CabinetPharma->getDetailReturnInfo($return_id);
