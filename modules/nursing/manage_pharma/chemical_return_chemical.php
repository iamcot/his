<?php
    ...
    $fileforward='../include/inc_return_chemical_save.php'.URL_APPEND;
    ...
    */
    ...
    $smarty->assign('sToolbarTitle',$LDReturnChemical.' :: '.$LDNewReportTab);
...
<!--
    function chkform(d) {
        document.newreturnform.action="../include/inc_return_chemical_save.php";
...
<?php
    ...
    $list_report_url='chemical_return_chemical_list.php';
    ob_start();
    require('../include/inc_chemical_report_tab.php');
    ...
    $smarty->assign('titleForm',$LDReturnChemical);
    ...
    if(!isset($target) || ($target=='new') || ($target=='create')){
        ...
        $listReport = $CabinetPharma->getDetailChemicalReturnInfo($return_id);
    ...
    $smarty->assign('sMainBlockIncludeFile','nursing/medicine_returnmed_1.tpl');
