...
$fileforward='../include/inc_use_medipot_save.php'.URL_APPEND;
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDUseVTYT.' :: '.$LDNewReportTab);
...
<!--
function chkform(d) {
	document.newuseform.action="../include/inc_use_medipot_save.php";
...
$list_report_url='medipot_use_ward_list.php';
ob_start();
...
$smarty->assign('titleForm',$LDKeKhaiVTYTTrongNgay);
...
if(!isset($target) || ($target=='new') || ($target=='create')){
		...
		$listReport = $CabinetMedipot->getDetailUseInfo($use_id);
