...
<!-- Begin
function sendValue(name,lotid,unit){
...
//        window.opener.document.getElementById('unit'+'<?php echo $id_number; ?>').value = unit;
//        var tbl = document.getElementsByTagName("tblSTT");
    ...
    if (window.XMLHttpRequest)
      ...
      {// code for IE6, IE5
		...
		if (xmlhttp.readyState==4 && xmlhttp.status==200){
			...
			tbl.tBodies[0].innerHTML = '<table id="tblItem" width="100%">' + xmlhttp.responseText + '</table>';
		}
	}
	
	xmlhttp.open("GET","cabinet_search_chemical_getdb.php?dept_nr=<?php echo $dept_nr; ?>&ward_nr=<?php echo $ward_nr; ?>&name_chemical="+name_chemical+"&group_chemical="+group_chemical+"&supplier="+supplier,true);
...
<form name="selectform">
    <table width="100%" cellpadding="2" bgcolor="#EEEEEE">
        <tr bgcolor="#ffffff"><td><font size="4" color="#5f88be"><b><?php echo $LDMoreSearch; ?></b><br>&nbsp;</td>
        </tr>
        <tr>
            <td>
                <table cellspacing="3">
                    <tr>
                        <td width="20%"><b><?php echo $LDChemicalName1; ?></b></td>
