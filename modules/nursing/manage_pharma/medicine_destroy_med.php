...
$fileforward='../include/inc_destroy_save.php'.URL_APPEND;
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDDestroyMedicine.' :: '.$LDNewReportTab);
...
<!--
function chkform(d) {
	document.newdestroyform.action="../include/inc_destroy_save.php";
...
$list_report_url='medicine_destroy_med_list.php';
ob_start();
...
$smarty->assign('titleForm',$LDDestroyMedicine);
...
if(!isset($target) || ($target=='new') || ($target=='create')){
		...
		$listReport = $CabinetPharma->getDetailDestroyInfo($des_id);
