...
function searchItem(){
	...
	var type_med = document.getElementById('type_med').value;
	...
	xmlhttp.open("GET","cabinet_search_medipot_getdb.php?dept_nr=<?php echo $dept_nr; ?>&ward_nr=<?php echo $ward_nr; ?>&name_med="+name_med+"&type_med="+type_med+"&group_med="+group_med+"&supplier="+supplier,true);
		...
		<tr><td>
			<table cellspacing="3">
				...
				<tr><td><b><?php echo $LDTypeMedipot; ?></b></td>
					<td><input type="text" id="type_med" size="40"></td>
