<?php
    ...
    $fileissue= '../nursing-issuepaper-chemical-depot.php'.URL_APPEND.'&dept_nr='.$dept_nr.'&ward_nr='.$ward_nr;
    $filereturn= 'chemical_return_chemical.php'.URL_APPEND.'&dept_nr='.$dept_nr.'&ward_nr='.$ward_nr;
    ...
    */
    ...
    $smarty->assign('sToolbarTitle',$LDInventoryCabinetChemical.' :: '.$LDChemicalList);
    ...
    <center>
        ...
        <table border="0" cellSpacing="1" cellPadding="3" width="95%" bgColor="#C3C3C3">
            <tr bgColor="#EDF1F4">
                ...
                <th><?php echo $LDCabinetChemicalSum; ?>&nbsp;
                    <input type="image" <?php echo createComIcon($root_path,$picup,'0','',TRUE) ?> onclick="sortUp()" title="<?php echo $LDSortUp; ?>">
                    &nbsp;<input type="image" <?php echo createComIcon($root_path,$picdown,'0','',TRUE) ?> onclick="sortDown()" title="<?php echo $LDSortDown; ?>">
                </th>	
		...
		if ($listItem = $Product->SearchCatalogChemicalCabinet($dept_nr, $ward_nr, $condition, $updown)){		
		...
		if ($total_pages>1)
                    $listItem = $Product->ShowCatalogChemicalCabinet($dept_nr, $ward_nr, $current_page, $number_items_per_page, $updown);
                ...
                $listItem = $Product->ShowCatalogChemicalCabinet($dept_nr, $ward_nr, $condition, $updown);
	...
	?>
        ...
        <table border="0" cellpadding="3" cellspacing="1" width="90%">
            ...
            <tr>
                ...
                <tr>
                    <td align="center">&nbsp;<br/>
                        <img <?php echo createLDImgSrc($root_path,'issue.gif','0','middle'); ?> OnClick="issueItem()" />
                        <img src="<?php echo $root_path; ?>gui/img/common/default/pixel.gif" border="0" width="30" height="16">
                        <img <?php echo createLDImgSrc($root_path,'return.gif','0','middle'); ?> OnClick="returnItem()">
                        &nbsp;
                    </td>
                </tr>
                <tr>
