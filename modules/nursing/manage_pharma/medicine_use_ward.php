...
$fileforward='../include/inc_use_save.php'.URL_APPEND;
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDUseMedicine.' :: '.$LDNewReportTab);
 ...
 # Window bar title
 $smarty->assign('title',$LDUseMedicine);
...
<!--
function chkform(d) {
	document.newuseform.action="../include/inc_use_save.php";
...
function deleteIssue()
{
	...
	if (r==true) {
		document.newuseform.action="<?php echo $fileforward;?>&isdelete=delete";
		document.newuseform.submit();
	}
}
function CalCost(i){
...
$list_report_url='medicine_use_ward_list.php';
ob_start();
...
$smarty->assign('titleForm',$LDKeKhaiThuocTrongNgay);
...
if(!isset($target) || ($target=='new') || ($target=='create')){
		...
		$listReport = $CabinetPharma->getDetailUseInfo($use_id);
