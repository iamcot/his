...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDUseMedipotReport.' :: '.$LD15DayReport);
...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/thongke15ngaydung.php<?php echo URL_APPEND; ?>&type=medipot&dept_nr="+dept+"&ward_nr="+ward+"&fromdate="+fromdate+"&todate="+todate;
