...
$breakfile='medicine_distribute_medicine.php'.URL_APPEND.'&dept_nr='.$dept_nr.'&ward_nr=';
$fileforward= 'medicine_distribute_save.php'.URL_APPEND.'&dept_nr='.$dept_nr.'&ward_nr=';
