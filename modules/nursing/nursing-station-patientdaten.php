...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$LDPhieuTheoDoiLamSang $station");
	...
	if ($edit) return 'onClick="javascript:pullRosebar(this)"></a>';
       ...
       /* Now create the first group of color event signaller */
		...
		<table cellpadding=0 width=100%>
                    <tr>
                        <td bgcolor=333333><font color=white><b>'.$LDCharts.'<b></font></td>
                    </tr>
                    <tr>
                        <td>
                            <table cellpadding=3 width=100%>
                                <tr>
                                    <td align="center" width="35%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-custom-inout.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$IO_title.'"></td>
                                    <td align="center" width="37%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-custom-ddc.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$DDC_title.'"></td>
                                    <td align="center" width="29%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-kurve.php'.URL_REDIRECT_APPEND.'&station='.$station.'&dept_nr='.$dept_nr.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$LDFeverCurve.'"></td>
                                </tr>
                                <tr>
                                    <td align="center" width="35%"><input style="width: 98%;"  type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-custom-tc.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$TC_title.'"></td>
                                    <td align="center" width="37%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-custom-noc.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$NOC_title.'"></td>
                                    <td align="center" width="29%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-getmedx.php'.URL_REDIRECT_APPEND.'&station='.$station.'&dept_nr='.$dept_nr.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$DailyTherapy.'"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor=333333><font color=white><b>'.$LDReports1.'<b></font></td>
                    </tr>
                    <tr>
                        <td>                            
                            <table cellpadding=3 width=100%>
                                <tr>
                                    <td align="center" width="35%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-pbericht.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$LDNursingReport.'"></td>
                                    <td align="center" width="37%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\''.$root_path.'main/diagnostics-report-start.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'&header='.$result['name_last'].',+'.$result['name_first'].'+'.formatDate2Local($result['date_birth'],$date_format).'\'" value="'.$LDPatDataFolder.'"></td>';
                                    if($result['current_dept_nr']==7){
                                        echo '<td align="center" width="34%"><input style="width: 98%;" type="button" onClick="javascript:window.location.href=\''.$root_path.'modules/nursing/nursing-station-patientdaten-kurve-bdcd.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&user_origin='.$user_origin.'&edit='.$edit.'\'" value="'.$LDReportSan.'"></td>';
                                    }else{
                                        echo '<td align="center" width="34%"><input style="width: 98%;" type="button" onClick="javascript:alert('."'$AlertPermission'".');" value="'.$LDReportSan.'"></td>';
                                    }
                    echo '      </tr>                                
                            </table>                            
                        </td>
                    ...
                    <tr>
                        <td bgcolor=333333><font color=white><b>'.$LDOther.'<b></font></td>
                    </tr>
                    <tr>
                        <td>
                            <table cellpadding=3 width=100%>
                                <tr>
                                    <td align="center" width="35%"><input style="width:98%;" type="button" onClick="javascript:openDRGComposite()" value="'.$LDDRG.'"></td>
                                    <td align="center" width="37%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-todo.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$LDDocsPrescription.'"></td>
                                    <td align="center" width="34%"><input style="width: 98%;" type="button" onClick="javascript:enlargewin();window.location.href=\''.$root_path.'modules/fotolab/fotos-start.php'.URL_REDIRECT_APPEND.'&pn='.$pn.'&station='.$station.'&fileroot='.$fr.'&edit='.$edit.'\'" value="'.$LDPhotos.'"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
