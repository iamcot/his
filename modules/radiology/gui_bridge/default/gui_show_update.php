...
# Title in toolbar
 $smarty->assign('sToolbarTitle',$page_title);
  ...
  # hide back button
 $smarty->assign('pbBack',$returnfile.'&type_nr='.$type_nr);
...
<table width=100% border=0 cellspacing="0"  cellpadding=0 >
	...
	<form method="post" name="entryform"  ENCTYPE="multipart/form-data"  action="<?php echo $thisfile.URL_REDIRECT_APPEND; ?>" onSubmit="return chkform(this)">
...
# Show input elements for additional info
	...
	if($imginfo=$img->SelectImgDiagInfo($nr)){
		...
		$doc_ref_ids = $imginfo['doc_ref_ids'];
		$notes=$imginfo['notes'];
	}		
...
<br>
		...
		<table width="100%">
			<tr bgcolor="#f6f6f6">
			<td><FONT class="prompt"><nobr><?php echo $LDImageGroupNr; ?><?php echo $nr ?>:</font>&nbsp<?php echo $LDUpdate; ?>
			</td>
			</tr>
		</table>
...
<input type="hidden" name="lang" value="<?php echo $lang; ?>">
 <?php echo $LDNewImageFiles; ?>.<input type="button" value="<?php echo $LDContinue; ?>" onclick="changeNumberUpdate();">
