...
$updatefile= 'update.php'.URL_APPEND.'&user_origin='.$local_user;
...
function uploadImg(pid,nr){
	var win = '<?php echo $updatefile; ?>&pid='+pid+'&nr='+nr;
...
<table border=0>
  <tr>
    <td><font size="2" color="#5f88be"><b>&nbsp;<?php echo $LDSearchWordPrompt ?></b></td>
  </tr>
  <tr>
...
<table border=0 cellpadding=0 cellspacing=0 width="100%">
  <tr>
    <th class="v12" width="5%"><b>&nbsp;<?php echo $LDPID ?></b></th>
    <th class="v12" width="5%"><b>&nbsp;<?php echo $LDLastName ?></b></th>
    <th class="v12" width="10%"><b>&nbsp;<?php echo $LDName ?></b></th>
    <th class="v12" width="5%"><b>&nbsp;<?php echo $LDBday ?></b></th>
    <th class="v12" width="1%">&nbsp;</th>
	<th class="v12" width="10%"><b>&nbsp;<?php echo $LDCaseNr ?></b></th>
    <th class="v12" width="5%"><b>&nbsp;<?php echo $LDUploadDate ?></b></th>
	<th class="v12" width="5%"><b>&nbsp;<?php echo $LDType ?></b></th>
    <th class="v12" width="5%"><b>&nbsp;<?php echo $LDNrImages ?></b></th>
    <th class="v12" width="25%"><b>&nbsp;<?php echo $LDFileName ?></b></th>
    <th class="v12" width="5%"><b>&nbsp;<?php echo $LDDownload ?></b></th>
<?php
if(!$pop_only){
?>
   <th class="v12" align=center><b>&nbsp;<?php echo $LDViewImage ?></b></th>
<?php
}
?>
    <th class="v12" align=center><b>&nbsp;<?php echo $LDViewInWindow ?></b></th>
 </tr>
  <tr>
    <td colspan=13 bgcolor="#0000ff"><img <?php echo $img_pix ?> width=1 height=1></td>
  </tr>
   <tr>
    <td colspan=13 bgcolor="#0000ff"></td>
  </tr>
<?php 
if($mode=='search'&&$rows){
	#
	...
	for($i=0;$i<$z;$i++){
		if($pdata[$i]['pid']!=$pdata[($i-1)]['pid']){
			...
			echo '<td class="v12" align="center">';
			if($pdata[$i]['encounter_nr']) 
				echo $pdata[$i]['encounter_nr'];
			echo '&nbsp;</td>';
			
			echo	'<td class="v12">&nbsp;'.formatDate2Local($pdata[$i]['upload_date'],$date_format).'&nbsp;';
			...
			//if(file_exists($root_path.'uploads/radiology/dicom_img/'.$pdata[$i]['pid'].'/'.$pdata[$i]['nr'].'.dcm')){
				...
				echo '<td colspan="4"><a href="javascript:uploadImg(\''.$pdata[$i]['pid'].'\',\''.$pdata[$i]['nr'].'\')"><font color="red">'.$LDMissingImageFile.'</font></a></td>';
			}
			echo '
				<tr bgcolor="'.$color.'">
					<td colspan=13 bgcolor="#0000ff"><img '.$img_pix.' width=1 height=1></td>
				</tr>';
			...
			if ($files) {
				foreach ($files as $file) {
					...
					echo '></td>
						...
						<td class="v12" align=center><a href="'.$pdata[$i]['path'].'/'.$file.'" title="'.$LDDownload.'"><img '.$img_download.'></a></td>';
					if(!$pop_only) echo '
		...
		//if(file_exists($root_path.'uploads/radiology/dicom_img/'.$pdata[$i]['pid'].'/'.$pdata[$i]['nr'].'.dcm')){
			...
			echo '<td colspan="4"><a href="javascript:gethelp(\'missing_file.php\',\''.$LDDicomImages.'\',\''.$sImagePath.'\')"><font color="red">'.$LDMissingImageFile.'</font></a></td>';
		}
		echo '
			<tr>
				<td colspan=13 bgcolor="#0000ff"><img '.$img_pix.' width=1 height=1></td>
