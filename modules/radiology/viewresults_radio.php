...
$breakfile='../laboratory/labor_test_request_admin_radio.php'.URL_APPEND.'&target='.$target.'&subtarget='.$subtarget.'&user_origin='.$user_origin;
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDXemKetQua.' :: '.$LDXQuang);

 # href for help button
 $smarty->assign('pbHelp',"javascript:gethelp('submenu1.php','$LDXQuang')");

 # Window bar title
 $smarty->assign('title',$LDXQuang);
...
<table cellSpacing="1" cellPadding="2" border="0" width="95%">
	<tr><th align="left"><font size="2" color="#85A4CD"><?php echo $LDXrayFilms; ?></th>
...
<table border="0" cellSpacing="1" cellPadding="3" width="95%" bgColor="#C3C3C3">
	...
	if ($search==''){
		...
		$total= $CDHA->countResultsXQItems($condition);
		...
		$listItem = $CDHA->listResultsXQSplitPage($current_page, $number_items_per_page, $condition);
		...
		$listItem = $CDHA->listResultsXQ($condition);
