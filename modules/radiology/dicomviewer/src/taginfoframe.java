...
public class TagInfoFrame extends Frame {
  ...
  Vector      vector8 = new Vector();      // (0008,????)のタグの情報が格納される
  Vector      vector10 = new Vector();     // (0010,????)のタグの情報が格納される
  Vector      vector18 = new Vector();     // (0018,????)のタグの情報が格納される
  Vector      vector20 = new Vector();     // (0020,????)のタグの情報が格納される
  Vector      vector28 = new Vector();     // (0028,????)のタグの情報が格納される
  Vector      vectorOther = new Vector();  // 上記以外のタグの情報はここに格納
