...
$aSubMenuText=array($LDTestRequestRadioTxt,
										$LDTestReceptionTxt,
										$LDTestReceptionMonoTxt,
										$LDTestReceptionDTTxt,
										$LDDicomImagesTxt,
										$LDUploadDicomTxt,
										$LDSelectViewerTxt,
										$LDNewsTxt
...
$aSubMenuItem=array('LDTestRequestRadio' => "<a href=\"".$root_path."modules/laboratory/labor_test_request_pass.php".URL_APPEND."&target=radio&user_origin=lab\">$LDTestRequestRadio</a>",
										...
										'LDTestReceptionMono' => "<a href=\"".$root_path."modules/laboratory/labor_test_request_pass.php".URL_APPEND."&target=admin&subtarget=mono&user_origin=lab\" >$LDTestReceptionMono</a>",
										'LDTestReceptionDT' => "<a href=\"".$root_path."modules/laboratory/labor_test_request_pass.php".URL_APPEND."&target=admin&subtarget=dientim&user_origin=lab\" >$LDTestReceptionDT</a>",
