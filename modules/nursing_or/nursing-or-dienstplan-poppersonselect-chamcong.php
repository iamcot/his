...
function addelem(elem,hid,last,first,b,nr,nr_t,nr_d,nr_s,nr_s_t,nr_s_d)
{
...
<b>
<?php echo $LDChamcong ?><br>
<?php if ($mode=="a") echo '<font color="#006666">'.$LDSang.'</font>'; else echo $LDChieu;

echo '&nbsp'.$LDFullDay[$wkday].'&nbsp';
 echo '<font color=navy>';
 echo formatDate2Local($year.'-'.$month.'-'.($elemid+1),$date_format).'</font>'; 
?>
</b>
</font>
<p>
