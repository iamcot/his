...
switch($target){
	...
	default: $title=$LDMakeDutyPlan;
					  $fileforward='nursing-or-dienstplan-planen-chamcong.php'.URL_APPEND.'&retpath='.$retpath;
					  break;
}
...
while(list($x,$v)=each($dept_DOC)){
	...
	<img '.createLDImgSrc($root_path,'ok_small.gif','0','right').' alt="'.$LDShowActualPlan.'" ></a> </td></tr>';
	echo "\n";
}
