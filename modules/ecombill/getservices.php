...
<tr  bgColor="#eeeeee">
	<td align="center" height="7" width="45">
		<input name="'.$buf1['item_description'].'" id="'.$buf1['item_code'].'" type="checkbox">
	</td>
	...
	<td align="center" height="7"><input type="text" name="count"></td>
</tr>';
$i++;
}
...
<tr  bgColor="#eeeeee">
	<td align="center" height="7" width="45">
		<input name="'.$buf['item_description'].'" id="'.$buf['item_code'].'" type="checkbox">
	</td>
