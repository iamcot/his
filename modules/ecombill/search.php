...
?>
	...
	<td <?php echo $tbg; ?> align='center'><FONT  SIZE=-1  FACE="Arial" color="#ffffff"><b> <?php echo $pagen->makeSortLink($LDIsTransfer,'is_transfer',$oitem,$odir,$append); ?></b></td>
