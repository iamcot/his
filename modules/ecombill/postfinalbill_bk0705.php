...
$eComBill->createPaymentItem($patientno,$receipt_no,$presdatetime,$currentamt,'0','0','0','0',$currentamt,$final_bill_no);

$patmenu="showfinalbill.php".URL_REDIRECT_APPEND.'&patientno='.$patientno.'&full_en='.$full_en.'&service='.$service;
