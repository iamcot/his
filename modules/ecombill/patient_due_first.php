...
$tien = number_format($LDTotalBillAmountData,0,",",",");
$smarty->assign('LDTotalBillAmountData','<input type="text" id="totalcost" name="totalcost" value="'.$tien.'" readonly style="border:0px;width:150px;text-align:right;font-weight:bold;">');
//Doc tien thanh chu
