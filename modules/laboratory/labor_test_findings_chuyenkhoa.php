...
function printOut()
{
urlholder="<?php echo $root_path;?>modules/pdfmaker/chuyenkhoa/PhieuKhamChuyenKhoa_ketqua.php<?php echo URL_APPEND; ?>&enc=<?php echo $pn;?>";
...
require_once($root_path.'modules/laboratory/includes/inc_test_findings_form_'.$subtarget.'.php');
