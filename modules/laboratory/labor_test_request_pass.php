...
if($target=='generic'){
	switch($subtarget){
		...
		case 90: $target='admin'; $subtarget='radio'; break; # 19 = radiology
		...
		case 44: $target='admin'; $subtarget='visinh'; break; # 25 = bacteriological lab
		case 41: $target='admin'; $subtarget='blood';  break; # 41 = blood bank
		case 42: $target='admin'; $subtarget='dientim'; break;
		case 43: $target='admin'; $subtarget='chuyenkhoa'; break;
	}
}
