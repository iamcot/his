...
$formtitle='Xét nghiệm tế bào cổ tử cung';

//$db_request_table=$subtarget;
$db_request_table='tucung';
//echo $subtarget;
//$db->debug=1;
...
switch($mode){
	case 'update':
	{
		...
		if($ergebnis=$core->Transact($sql)){
			...
			//include('labor_test_findings_duonghuyet.php?sid=$sid&lang=$lang&user_origin=$user_origin&mode=save&pn=$pn&batch_nr=$batch_nr&target=$target&subtarget=$subtarget');
...
if(!$mode||$mode=='') {
	$sql="SELECT batch_nr,encounter_nr,send_date FROM dfck_xn_".$db_request_table."
...
if($batchrows && $pn){
	...
	if( $enc_obj->loadEncounterData($pn)) {
		...
		if( $enc_obj->is_loaded){
			...
			$sql="SELECT * FROM dfck_xn_".$db_request_table." WHERE batch_nr='".$batch_nr."'";
...
function doneRequest(){
	...
	if (r==true) {
		document.form_test_request.action="<?php echo 'labor_test_findings_duonghuyet.php?sid='.$sid.'&lang='.$lang.'&batch_nr='.$batch_nr.'&pn='.$pn.'&target='.$target.'&subtarget='.$subtarget.'&user_origin='.$user_origin.'&mode=done'; ?>";
...
<table border=0 bgcolor="#000000" cellpadding=1 cellspacing=0>
 ...
 <?php
    ...
    <tr>
		<td>
			<?php echo "Vị trí lấy bệnh phẩm :" ;?>
		</td>
		<td align="right" >
			Âm đạo <input type="radio" name="vitri_benhpham" value="1" <?php if($stored_request['vitri_benhpham']==1) echo "checked"; else echo "";?> disabled>
		</td>
		<td align="right">
			Cổ ngoài <input type="radio" name="vitri_benhpham" value="2" <?php if($stored_request['vitri_benhpham']==2) echo "checked"; else echo "";?> disabled>
		</td>
		<td align="right">
			Cổ trong <input type="radio" name="vitri_benhpham" value="3" <?php if($stored_request['vitri_benhpham']==3) echo "checked"; else echo "";?> disabled >
		</td>
	</tr>
	<tr>
		<td>
			<?php echo "Ngày kinh chót :" ;?>
		</td>
		<td align="right">
			Thai: Có <input type="radio" name="ngaykinhchot" value="1" <?php if($stored_request['ngaykinhchot']==1) echo "checked"; else echo "";?> disabled>
		</td>
		<td align="right">
			Không <input type="radio" name="ngaykinhchot" value="2" <?php if($stored_request['ngaykinhchot']==2) echo "checked"; else echo "";?> disabled>
		</td>
		<td align="right">
			Không rõ <input type="radio" name="ngaykinhchot" value="3" <?php if($stored_request['ngaykinhchot']==3) echo "checked"; else echo "";?> disabled>
		</td>
	</tr>
	<tr>
		<td>
			<?php echo "Điều trị nôi tiết tố :" ;?>
		</td>
		<td align="right">
			Có <input type="radio" name="dtnoitietto" value="1" <?php if($stored_request['dtnoitietto']==1) echo "checked"; else echo "";?> disabled>
		</td>
		<td align="right">
			Không <input type="radio" name="dtnoitietto" value="2" <?php if($stored_request['dtnoitietto']==2) echo "checked"; else echo "";?> disabled>
		</td>
  ...
  &nbsp;<br>
		 ...
		 <tr bgcolor="<?php echo $bgc1 ?>">
			<td colspan=3><div class=fva2_ml10><?php echo "Chẩn đoán lâm sàng cổ tử cung :" ?><br>
				<font face="courier" size=2 color="#000099"><?php echo stripslashes($stored_request['chandoanls_ctc']) ?></font>
			</td>
		</tr>	
		<tr bgcolor="<?php echo $bgc1 ?>">
			<td colspan=3><div class=fva2_ml10><?php echo "Chẩn đoán soi cổ tử cung" ?>:<br>
				<font face="courier" size=2 color="#000099"><?php  echo stripslashes($stored_request['chandoansoi_ctc']) ?></font>
			</td>
		</tr>	
		<tr bgcolor="<?php echo $bgc1 ?>">
			<td colspan=3><div class=fva2_ml10><?php echo "Chẩn đoán giải phẫu bệnh" ?>:<br>
				<font face="courier" size=2 color="#000099"><?php echo stripslashes($stored_request['cdgiaiphau']) ?></font>
			</td>
		</tr>	
		<tr bgcolor="<?php echo $bgc1 ?>">
			<td colspan=3><div class=fva2_ml10><?php echo "Chẩn đoán tế bào CTC" ?>:<br>			
			
			</td>
		</tr>	
		<tr bgcolor="<?php echo $bgc1 ?>">
			<td colspan=4><div class=fva2_ml10>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "Lần 1 :" ?>&nbsp;&nbsp;		
				<font face="courier" size=2 color="#000099"><?php  echo stripslashes($stored_request['cdtebaohoc_1']) ?></font>
			</td>
		</tr>	
		<tr bgcolor="<?php echo $bgc1 ?>">
			<td colspan=4><div class=fva2_ml10>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "Lần 2 :" ?>&nbsp;&nbsp;		
				<font face="courier" size=2 color="#000099"><?php echo stripslashes($stored_request['cdtebaohoc_2']) ?></font>
			</td>
		</tr>	
		<tr bgcolor="<?php echo $bgc1 ?>">
			<td colspan=4><div class=fva2_ml10>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "Lần 3 :" ?>&nbsp;&nbsp;		
				<font face="courier" size=2 color="#000099"><?php echo stripslashes($stored_request['cdtebaohoc_3']) ?></font>
			</td>
		</tr>	
	...
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2 align="right"class="adm_input"><div class=fva2_ml10>
		 <?php echo $LDDate ?>:
  ...
  <?php echo $LDRequestingDoc ?>:
	...
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2 class="adm_item"> 
			&nbsp;<font color="#000099" style="font-weight:bold;"><?php echo "I.ĐÁNH GIÁ PHẾT:"?></font>
        	
		 </td>
	</tr>	
	<tr>
		<td>
			<input type="radio" name="" value="">Đạt yêu cầu để chẩn đoán: <br><br>
        	<input type="radio" name="" value="">Đạt yêu cầu để chẩn đoán nhưng bị hạn chế, do :<br><br>			
        	<input type="radio" name="" value="">Không đạt yêu cẩu để chẩn đoán, do: 		
		</td>
		<td>
			<input type="text" value="" name="" size="60"><br><br>
			<input type="text" value="" name="" size="60"><br><br>
			<input type="text" value="" name="" size="60">
		</td>
	</tr>
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2 class="adm_item"> 
		 &nbsp;<font color="#000099" style="font-weight:bold;"><?php echo "II.MÔ TẢ CHẨN ĐOÁN TẾ BÀO HỌC:"?></font><br>
        	
		 </td>
	</tr>	
		<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2> 
			<input type="checkbox" name="" value="">Tế bào trong giới hạn bình thường <br>
        	<input type="checkbox" name="" value="">Tế bào nội mạc tử cung lành tính
		 </td>
	</tr>
<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2> 
		 <div class=fva2_ml10>&nbsp;&nbsp;&nbsp;<br><font color="#000099" style="font-weight:bold;"><?php echo "BIẾN ĐỔI TẾ BÀO LÀNH TÍNH:"?></font>
        	
		 </td>
	</tr>
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td width="50%"> 
		 <div class=fva2_ml10>&nbsp;&nbsp;&nbsp;<font color="#000099"><?php echo "Biến đổi tế bào do nhiễm trùng:"?></font><br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Trichomonas vaginalis <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Candida app<br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Tạp trùng <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Actinamyces app <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Herpes simplex virus <br>        	
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Khác
		 </td>
		 <td width="50%"> 
		 <div class=fva2_ml10>&nbsp;&nbsp;&nbsp;<font color="#000099"><?php echo "Biến đổi tế bào phản ứng do:"?></font><br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Viêm <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Viêm teo <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Xạ <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Vòng tránh thai <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Khác<br>
			
		 </td>
	</tr>
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2> 
		 <div class=fva2_ml10>&nbsp;&nbsp;&nbsp;<br><font color="#000099" style="font-weight:bold;"><?php echo "BẤT THƯỜNG TẾ BÀO BIỂU MÔ"?></font>
        	
		 </td>
	</tr>
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2> 
			&nbsp;&nbsp;<input type="checkbox" name="" value="">Tế bào gai không điển hình có ý nghĩa không xác định <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Có thể do phản ứng <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Có thể do bướu <br>
        	&nbsp;&nbsp;<input type="checkbox" name="" value="">Tổn thương trong biểu mô gai grade thấp(LSIL) <br>
        	&nbsp;&nbsp;<input type="checkbox" name="" value="">Tổn thương trong biểu mô gai grade cao(HSIL) <br>
        	&nbsp;&nbsp;<input type="checkbox" name="" value="">Carcinom tế bào gai <br>
        	&nbsp;&nbsp;<input type="checkbox" name="" value="">Tế bào tuyến không điển hình có ý nghĩa không xác định (AGUS) <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Có thể do phản ứng <br>
        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="" value="">Có thể do bướu <br>
        	&nbsp;&nbsp;<input type="checkbox" name="" value="">Carcinom tuyến cổ trong cổ tử cung <br>
        	&nbsp;&nbsp;<input type="checkbox" name="" value="">Carcinom tuyến nội mạc tử cung<br>
        	&nbsp;&nbsp;<input type="checkbox" name="" value="">Carcinom tuyến khác
	...
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2 align="right" class="adm_input"><div class=fva2_ml10><font color="#000099">
		 <?php echo $LDDate ?>
		
		<?php
			if($stored_request['results_date']==""){
				$dateshow=date("d/m/Y");
			}else{
				$dateshow=$stored_request['results_date'];
			}
			echo $calendar->show_calendar($calendar,$date_format,'results_date',$dateshow);
			//end : gjergji	
		?>
				  
  <?php echo 'Bác sĩ/KTV xét nghiệm' ?>
...
<p>
		<a href="#" onclick="saveResult()"><input type="image" <?php echo createLDImgSrc($root_path,'savedisc.gif','0') ?>  title="<?php echo $LDSaveEntry ?>"> </a>
		<a href="javascript:printOut()"><img <?php echo createLDImgSrc($root_path,'printout.gif','0') ?> alt="<?php echo $LDPrintOut ?>"></a>
		<a href="#" onclick="doneRequest()"><img <?php echo createLDImgSrc($root_path,'done.gif','0') ?> alt="<?php echo $LDEnterResult ?>"></a>
