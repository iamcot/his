...
$smarty->assign ( 'pbPrintPdf',$root_path."modules/pdfmaker/hoasinhmau/PhieuXetNghiemHoaSinhMau.php". URL_APPEND ."&enc=$pn");
$smarty->assign ('LDPrintPdfForm',$LDPrintPdfForm);
