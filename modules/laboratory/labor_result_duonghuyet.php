...
require('./roots.php');
$sql="select td.* from care_test_request_duonghuyet as td , care_test_findings_duonghuyet as fd where fd.batch_nr=td.batch_nr and fd.status='done' and td.batch_nr='".$batch_nr."' and td.encounter_nr='".$pn."'";
$temp=$db->execute($sql);
if($temp->recordcount()){
  ...
  <?php echo $LDRequestingDoc ?>:
	...
	<tr bgcolor="#ffffff">
		...
		//gjergji : new calendar
			...
			//end : gjergji	 
			echo ' Giờ :'.$findings_time;
		?>
				  
  <?php echo 'BS/KTV xét nghiệm :' ; ?>
