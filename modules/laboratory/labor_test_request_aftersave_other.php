...
if ($user_origin == 'lab') {
	...
	if ($target == 'radio')
		...
		$breakfile = $root_path . 'modules/registration_admission/aufnahme_daten_zeigen.php' . URL_APPEND. '&encounter_nr=' . $pn;
} else {
...
function printPdf()
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/visinh/visinh_yeucau.php<?php echo URL_APPEND; ?>&enc=<?php echo $pn;?>&batch_nr=<?php echo $batch_nr?>";
...
$smarty->display ( 'laboratory/request_aftersave_visinh.tpl' );
