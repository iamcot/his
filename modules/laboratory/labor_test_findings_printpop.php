...
elseif($subtarget=='duonghuyet'){
	include('labor_result_duonghuyet.php');
}
elseif($subtarget=='visinh'){
	include('labor_result_visinh1.php');
}
elseif($subtarget=='other'){
	include('labor_result_other.php');
}
else
{
