...
if($stored_request['material_type']=="pe_la") $tpbuffer='<img '.createComIcon($root_path,'radio_chk.gif','0','absmiddle');
...
if($stored_request['material_type']=="pe_no") $tpbuffer='<img '.createComIcon($root_path,'radio_chk.gif','0','absmiddle');
	else $tpbuffer='<img '.createComIcon($root_path,'radio_blk.gif','0','absmiddle');
$smarty->assign('input_material_type_pe_no',$tpbuffer.'>');

$smarty->assign('LDNo',$LDNo);
if($stored_request['material_type']=="pe_th") $tpbuffer='<img '.createComIcon($root_path,'radio_chk.gif','0','absmiddle');
	else $tpbuffer='<img '.createComIcon($root_path,'radio_blk.gif','0','absmiddle');
...
if($stored_request['material_type']=="cytology_th") $tpbuffer= '<img '.createComIcon($root_path,'radio_chk.gif','0','absmiddle');
	      else $tpbuffer= '<img '.createComIcon($root_path,'radio_blk.gif','0','absmiddle');
$smarty->assign('input_material_type_cytology_th',$tpbuffer.'>');

$smarty->assign('LDCytologyTh',$LDCytologyTh);
if($stored_request['material_type']=="cytology_sa") $tpbuffer= '<img '.createComIcon($root_path,'radio_chk.gif','0','absmiddle');
	      else $tpbuffer= '<img '.createComIcon($root_path,'radio_blk.gif','0','absmiddle');
$smarty->assign('input_material_type_cytology_sa',$tpbuffer.'>');

$smarty->assign('LDCytologySa',$LDCytologySa);
if($stored_request['material_type']=="cytology_la") $tpbuffer= '<img '.createComIcon($root_path,'radio_chk.gif','0','absmiddle');
	      else $tpbuffer= '<img '.createComIcon($root_path,'radio_blk.gif','0','absmiddle');
