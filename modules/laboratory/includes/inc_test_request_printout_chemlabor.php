...
<table border=0 cellpadding=0 cellspacing=0 width=745 bgcolor="<?php echo $bgc1 ?>">
	<tr >
		...
		<font face="courier" size=2 color="#000000"><b><?php echo 'Ngày gởi'?>&nbsp;<?php 
...
for($i=0;$i<=$max_row;$i++) {
	...
	for($j=0;$j<=$column;$j++) {
			if($LD_Elements[$j][$i]['type']=='top') {
				echo '<td bgcolor="#ee6666" colspan="2"><font color="white">&nbsp;<b>'.$parametergruppe[$LD_Elements[$j][$i]['value']].'</b></font></td>';
			} else {
