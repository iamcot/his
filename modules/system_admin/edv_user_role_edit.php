            ...
            <td>
                <table border="0" cellpadding="5" cellspacing="1">
                    ...
                    <tr bgcolor="#dddddd">
                        <td>
                            ...
                            <input name="role_name" type="hidden"
                                <?php
                                    if ($role_name != "")
                                        echo ' value="'.$role_name.'"><br><b>'.$role_name.'</b>';
                                    else
                                        echo '>' ;
                                    }else{
                                ?>
                    ...
                    <tr bgcolor="#dddddd">
                        <td  colspan=3>
                            <?php
                                //file gốc là $LDAllowedAreaRole nhưng không có giá trị nào
                                if($errorbereich){
                    ...
                    <tr bgcolor="#dddddd">
                        <td  colspan=3>
                            <table border=0 cellspacing=0 width=100%>
                                ...
                                $i=0;
                                //$area_opt nằm trong global_config/areas.php
...
//                                        if(stristr ('title',$x )){ // If title print it out
                                        if(substr($x, 0, 5)== 'title'){
                                            ...
                                            switch ($cindex) {
                                                case 0 ://là quyền cấp 1
                                                    echo '<td  valign=top colspan=5><img '.createComIcon($root_path,'redpfeil.gif','0','absmiddle').'>';
                                                    if (substr($x, 0, 5)!= 'title') {
                                                    ...
                                                    echo $v.'</td>' ;
                                                    break ;
                                                case 1 ://là quyền cấp 2
                                                    echo '<td><img src="p.gif" width=15></td>
                                                          <td  valign=top colspan=4>
                                                            <img src="tl2-blue.gif" border=0 width=20 height=21 align="absmiddle">
                                                    ...
                                                    echo $v.'</td>' ;
                                                    break ;
                                                case 2 ://là quyền cấp 3
                                                    echo '<td><img src="p.gif" width=15></td>
                                                          <td><img src="p.gif" width=15><td  valign=top colspan=3><img src="tl2-blue.gif" border=0 width=20 height=21 align="absmiddle"><input type="checkbox" name="' . $x . '" value="' . $x . '" ' ;
                                                    if ($edit && strstr ( $userRole [ 'permission' ], $x ))
                                                            echo 'checked ><FONT    SIZE=2  FACE="Arial" color="#ff0000">' ; else
                                                            echo '>' ;
                                                    echo $v.'</td>' ;
                                                    break ;
                                                case 3 ://là quyền cấp 4
                                                    echo '
