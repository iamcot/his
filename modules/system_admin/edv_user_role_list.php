                        ...
                        <td>
                            <table border="0" cellpadding="5" cellspacing="1">';
                                echo '<tr class="submenu">';
                                    echo "<td colspan=8 align='center'><FONT color=\"#800000\" size='3'><b>$LDAccessRight</b></td>";
                                echo "</tr>"; 
                                echo '<tr class="wardlisttitlerow">';
                                    for($i=0;$i<sizeof($LDRoleIndex);$i++)
                                        echo "<td align='center'><b>".$LDRoleIndex[$i]."</b></td>";
                                echo "</tr>"; 
                            ...
                            while ($zeile=$ergebnis->FetchRow()) {  
                                echo "<tr class=\"wardlistrow1\">\n";
                                    echo "<td>".$zeile['role_name']."</td>\n";
                                    echo "</td>\n <td>";
                                /* Display the permitted areas */
                                $area=explode(' ',$zeile['permission']);
                                for($n=0;$n<sizeof($area);$n++) echo $area_opt[$area[$n]].'<br>';
                                    echo "<td align='center'>
                                            <a href=edv_user_role_edit.php?sid=$sid&lang=$lang&mode=edit&id=".$zeile['id']." title=\"$LDChange\"> $LDChange</a>
                                            <br><br>
                                            <a href=edv_user_role_delete.php?sid=$sid&lang=$lang&itemname=".$zeile['id']." title=\"$LDDelete\">	$LDDelete</a> 
                                          </td>";
                                echo "</tr>";
                            };
                        echo "</table>
