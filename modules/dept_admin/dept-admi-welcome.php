...
$breakfile=$root_path.'modules/dept_admin/dept-admi-welcome.php'.URL_APPEND;
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$LDSystemAdmin");
...
<?php echo $LDDeptAlert ?></font><p>

<p>
<a href="<?php echo $root_path ?>main/spediens.php<?php echo URL_APPEND ?>" target="_parent"><img <?php echo createLDImgSrc($root_path,'cancel.gif','0') ?>></a>
</ul>
