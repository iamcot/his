	...
	<?php 	
 	...
 	?>
			...
			<tr>
				...
				<td class=pblock><?php echo nl2br($dept['description']) ?>
</td>
			</tr>
			...
			<tr>
				<td class=pblock align=right bgColor="#eeeeee"><?php echo $LDTelephone ?> 1 (nội bộ): </td>
...
-->
	...
	<input type="hidden" name="sid" value="<?php echo $sid; ?>"> 
        ...
        <input type="submit" class="butedit" value="">
        <!-- <?php echo $LDUpdateData; ?> -->
        <a href="javascript:history.back()" class="butcancel"><img
