...
if($batchrows && $issue_id){
	...
	if($medicine_in_pres = $IssuePaper->getAllMedipotInIssuePaper($issue_id)){
...
include('includes/inc_issuepaper_medipot_request_lister_fx.php');
				...
				<td align="center">
					<?php if(($edit || $read_form) && $medicine_count){ 
						if($issue_show = $IssuePaper->getIssuePaperInfo($issue_id))
							require('includes/inc_issuepaper_medipot_in_issue.php');
					} ?>
				</td>
			</tr>    <!-- *************************************************************************************    -->
			<tr><td>&nbsp;<br></td></tr>
