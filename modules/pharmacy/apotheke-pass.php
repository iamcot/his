...
switch($mode) {
	...
	case "destroy_med":$title=$LDMedDestroy;
        ...
        case "khochan_putin_chemical":$title=$LDPutIn;
                        ...
                        break;
        case "khochan_payout_chemical":$title=$LDPayOut;
                        $allowedarea[] = '_a_1_pharmadbadmin';	
                        $src="issuepass";
                        $userck="ck_prod_order_user";
                        $fileforward=$root_path."modules/pharmacy/chemical_request_khochan_payout.php".URL_APPEND.'&user_origin='.$userck.'&mode=khochan';
                        break;
        case "khole_putin_chemical":$title=$LDPayOut;
                        $allowedarea[] = '_a_1_pharmadbadmin';	
                        $src="issuepass";
                        $userck="ck_prod_order_user";
                        $fileforward=$root_path."modules/pharmacy/chemical_request_khochan_payout.php".URL_APPEND.'&user_origin='.$userck.'&mode=khole';
                        break;
        //Cac phong khoa
	case "issuepaper_chemical":$title=$LDChemicalIssue;
                        $allowedarea[] = '_a_1_pharmadbadmin';	
                        $src="issuepass";
                        $userck="ck_prod_order_user";
                        $fileforward=$root_path."modules/pharmacy/pharma_request_chemical_ward.php".URL_APPEND.'&user_origin='.$userck;
                        break;
	case "pres_chemical":$title=$LDChemicalPrescription;
                        $allowedarea[] = '_a_1_pharmadbadmin';	
                        $src="issuepass";
                        $userck="ck_prod_order_user";
                        $fileforward=$root_path."modules/pharmacy/pharma_request_chemical_patient.php".URL_APPEND.'&user_origin='.$userck;
                        break;
	case "return_chemical":$title=$LDChemicalReturn;
                        $allowedarea[] = '_a_1_pharmadbadmin';	
                        $src="issuepass";
                        $userck="ck_prod_order_user";
                        $fileforward=$root_path."modules/pharmacy/pharma_request_chemical_return.php".URL_APPEND.'&user_origin='.$userck;
                        break;
	case "destroy_chemical":$title=$LDChemicalDestroy;
                        $allowedarea[] = '_a_1_pharmadbadmin';	
                        $src="issuepass";
                        $userck="ck_prod_order_user";
                        $fileforward=$root_path."modules/pharmacy/pharma_request_chemical_destroy.php".URL_APPEND.'&user_origin='.$userck;
                        break;	
        //**************************************************
