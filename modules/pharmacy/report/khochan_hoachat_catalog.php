<?php
    ...
    $urlsearch=$thisfile;
    $fileputin='../putin_chemical.php'.URL_APPEND;
    ...
    */
    ...
    $smarty->assign('sToolbarTitle',$LDKhoChan.' :: '.$LDChemicalList);

    # href for help button
    $smarty->assign('pbHelp',"javascript:gethelp('submenu1.php','$LDIssuePaper')");

    # Window bar title
    $smarty->assign('Name',$LDChemicalList);
        ...
        <tr>
            ...
            <td align="right" rowspan="3">
                <table>
                    <tr>
                        <td>
                            <input type="text" id="search" name="search" value="" size="30" />
                        </td>
                    <td>
        ...
        <tr>
            <th align="left" valign="top">
                <font size="2" color="#85A4CD">
                    <?php echo $LDChemicalList; ?>
                </font>
            </th>
        </tr>
        <tr>
            <td align="left" valign="top">
                <?php echo $LDOClock.': '.$datetime; ?>
            </td>
        </tr>
    </table>
<p>
<table border="0" cellSpacing="1" cellPadding="3" width="95%" bgColor="#C3C3C3">
    ...
    <?php 
        if ($search==''){
            ...
            if ($listItem = $Product->SearchNumberChemicalCatalogKhoChan($condition, $updown)){		
            ...
            if ($total_pages>1)
                $listItem = $Product->ShowNumberChemicalCatalogKhoChan($current_page, $number_items_per_page, $updown);
            ...
            $listItem = $Product->SearchNumberChemicalCatalogKhoChan($condition, $updown);
            $breakfile = $thisfile;
        }
        ...
        if(is_object($listItem)){
            ...
            for ($i=0;$i<$listItem->RecordCount();$i++)
            {
               ...
               /* $sTemp=$sTemp.'<tr bgColor="'.$bgc.'" >
                                                    ...
                                                    <td align="center">'.$rowItem['product_encoder'].'</td>
                                                    <td align="center">'.$rowItem['lotid'].'</td>
                                                    <td align="center">'.$rowItem['price'].' '.$rowItem['short_name'].'</td>
                                                    <td align="center">'.$expdate.'</td>
                                                    <td align="center">'.$rowItem['number'].'</td>
                                                    <td align="center"></td>
                                                </tr>
                                            </table>
                                            </div>                                        
        ...
        <tr>
            ...
            <table border="0" cellpadding="2" cellspacing="1" bgColor="#B4B4B4">
                <tr>
                    ...
                    <td bgColor="#ffffff">
                        <?php echo $LDListGuideKhoChan1; ?>
                    </td>
                </tr>
                <tr>
                    <td style="background-color:#AAFFFF;">&nbsp;</td>
                    <td bgColor="#ffffff">
                        <?php echo $LDListGuideKhoChan2; ?>
                    </td>
                </tr>
                <tr>
                    <td style="background-color:#ffffff;">&nbsp;</td>
                    <td bgColor="#ffffff">
                        <?php echo $LDListGuideKhoChan3; ?>
                    </td>
                </tr>
            </table>
            </td>
