...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDKhoChan.' :: '.$LDSuDungThuocTamThan);

 # href for help button
 $smarty->assign('pbHelp',"javascript:gethelp('submenu1.php','$LDSuDungThuocTamThan')");

 $smarty->assign('breakfile',$breakfile);

 # Window bar title
 $smarty->assign('title',$LDSuDungThuocTamThan);
...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/khochan_sudungthuoc_tamthan.php<?php echo URL_APPEND; ?>&type_month="+type_month+"&showmonth="+month+"&showyear="+year;
...
$smarty->assign('titleForm',$LDSuDungThuocTamThan);
