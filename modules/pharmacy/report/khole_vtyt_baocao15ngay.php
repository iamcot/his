...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/khole_thongke15ngaydung.php<?php echo URL_APPEND; ?>&type=medipot&fromdate="+fromdate+"&todate="+todate+"&select_type="+select_type;
