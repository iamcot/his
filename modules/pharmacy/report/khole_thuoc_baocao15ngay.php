...
# Title in the toolbar
 ...
 # Window bar title
 $smarty->assign('title',$LDReportUse15Day);
...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/khole_thongke15ngaydung.php<?php echo URL_APPEND.'&dongtayy='.$type; ?>&type=medicine&fromdate="+fromdate+"&todate="+todate+"&select_type="+select_type;
...
$listReport = $CabinetPharma->reportMedicine15Day($fromdate, $todate, $cond_typeput.$dongtayy);
