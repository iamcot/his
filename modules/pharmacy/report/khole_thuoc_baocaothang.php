...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/khole_baocaosudungthuoc.php<?php echo URL_APPEND; ?>&type=medicine&select_type="+select_type+"&monthreport="+month+"&yearreport="+year;
...
switch($select_type){	
	case 0: $listReport = $CabinetPharma->reportMedicineMonth($monthreport,$yearreport,$dongtayy); break;
	case 1: $listReport = $CabinetPharma->reportMedicineKPMonth($monthreport,$yearreport,$dongtayy); break;
	case 2: $listReport = $CabinetPharma->reportMedicineBHMonth($monthreport,$yearreport,$dongtayy); break;
	case 3: $listReport = $CabinetPharma->reportMedicineCBTCMonth($monthreport,$yearreport,$dongtayy); break;
	default: $listReport = $CabinetPharma->reportMedicineMonth($monthreport,$yearreport,$dongtayy);
}
