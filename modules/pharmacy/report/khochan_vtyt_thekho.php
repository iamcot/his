...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDKhoChan.' :: '.$LDThekho.' - '.$LDMedipot);
...
function printOut(select_type,fromdate,todate)
{
	...
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/khochan_vtyt_thekho.php<?php echo URL_APPEND; ?>&select_type="+select_type+"&encoder="+encoder+"&fromdate="+fromdate+"&todate="+todate;
...
function Medicine_AutoComplete(){
			...
			var includeScript =  "khochan_autocomplete_medipot.php?type=<?php echo $type; ?>";
...
//***********************************NOI DUNG TRANG********************************
$smarty->assign('LDname',$LDMedipotName.': ');
...
$result_ton = $Pharma->Khochan_vtyt_tontruoc($encoder, $cond_typeput." AND toninfo.todate<'$ngaynhapxuat_gannhat' ");	
	if($result_ton!=false){
