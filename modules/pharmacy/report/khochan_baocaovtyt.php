...
$fileforward='khochan_baocaovtyt_save.php'.URL_APPEND;
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDKhoChan.' :: '.$LDReportImportExport_Medipot);
 ...
 # Window bar title
 $smarty->assign('title',$LDReportImportExport_Medipot);
...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/khochan_vtyt_nhapxuatton.php<?php echo URL_APPEND; ?>&select_type="+select_type+"&typedongtay=<?php echo $type;?>"+"&month="+month+"&year="+year+"&lastmonth="+lastmonth+"&lastyear="+lastyear;
...
//***********************************NOI DUNG TRANG********************************
$smarty->assign('LDReportMedicine',$LDReportMedipot);
$smarty->assign('titleForm',$LDReportImportExport_Medipot);
...
$listReport = $Pharma->Khochan_vtyt_nhapxuatton($cond_typeput, $showmonth, $showyear);
