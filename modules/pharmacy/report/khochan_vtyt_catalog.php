...
$urlsearch=$thisfile;
$fileputin='../putin_medipot.php'.URL_APPEND;
...
# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDKhoChan.' :: '.$LDMedipotCatalogue);

 # href for help button
 $smarty->assign('pbHelp',"javascript:gethelp('submenu1.php','$LDIssuePaper')");

 # Window bar title
 $smarty->assign('title',$LDMedipotCatalogue);
...
<table cellSpacing="1" cellPadding="3" border="0" width="90%">
	...
	<tr><th align="left" valign="top"><font size="2" color="#85A4CD"><?php echo $LDMedipotCatalogue; ?></th></tr>
...
<table border="0" cellSpacing="1" cellPadding="3" width="95%" bgColor="#C3C3C3">
	...
	if ($search==''){
		...
		if ($listItem = $Product->SearchNumberCatalogMedipotKhoChan($condition, $updown)){		
		...
		if ($total_pages>1)
			$listItem = $Product->ShowNumberCatalogMedipotKhoChan($current_page, $number_items_per_page, $updown);
		...
		$listItem = $Product->SearchNumberCatalogMedipotKhoChan($condition, $updown);
		$breakfile = $thisfile;
	}
...
<table border="0" cellpadding="3" cellspacing="1" width="90%">
	...
	<tr><td align="center">&nbsp;<p>
		...
		<a href="javascript:window.print();"><img <?php echo createLDImgSrc($root_path,'printout.gif','0','middle'); ?> ></a><p>&nbsp;</td></tr>
	<tr>
	<td align="right">
