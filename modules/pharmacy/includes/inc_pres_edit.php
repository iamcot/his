...
$patmenu="../pharma_request_medicine_patient.php".URL_REDIRECT_APPEND."&full_en=".$_POST['encounter_nr']."&lang=".$_POST['lang']."&target=$target&pid=".$_SESSION['sess_pid']."&radiovalue=".$radiovalue."&typeInOut=".$typeInOut."&user_origin=".$user_origin.'&pres_id='.$pres_id.'&tracker='.$tracker.'&pn='.$pn;
if(!$no_redirect){
