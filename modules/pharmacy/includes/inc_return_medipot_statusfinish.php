...
{ 
	if($medicine = $Cabinet->getMedicineInReturn($nr)){
		...
		$Product->updateMedipotAvaiProduct($encoder, $lotid, $number,'+', $typeput);
		...
		$Cabinet->insertArchive($dept_nr, $ward_nr, $encoder, $lotid, '0', $number, 0, 0, 0, $report_id, 0, $user_accept, $typeput);
