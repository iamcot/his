...
function printOut()
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/nhapkhochan.php<?php echo URL_APPEND; ?>&report_id=<?php echo $report_id; ?>&type=medicine";
...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/bienbankiemnhapkhochan.php<?php echo URL_APPEND; ?>&report_id=<?php echo $report_id; ?>&type=medicine";
	testprintpdf=window.open(urlholder,"PhieuNhapKho","width=1000,height=760,menubar=yes,resizable=yes,scrollbars=yes");
...
?>
	...
	<table border=0 cellpadding=3 width="98%">
		<tr><td colspan="4" align="center"><b> <?php echo $LDPharmaPutInMedicine; ?> </b> <br> &nbsp; </td></tr>
		<tr bgcolor="#f6f6f6">
		...
		<tr>
			<td colspan="4" align="center"><br>
				<table bgcolor="#EEEEEE" width="100%" cellpadding="3">
					<tr bgColor="#E1E1E1" >
						...
						<td width="5%" align="center"><u><?php echo $LDMedicineID1 ?></u></td>
						...
						<td width="9%" align="center"><u><?php echo $LDRequest1 ?></u></td>
						<td width="9%" align="center"><u><?php echo $LDNhan ?></u></td>
						<td width="14%" align="center"><u><?php echo $LDCost2 ?></u></td>
						<td width="9%" align="center"><u><?php echo $LDNote ?></u></td>
					</tr>
			...
			<?php 
				...
				echo '<tr bgColor="#ffffff" >
						...
						<td align="center" bgColor="#ffffff">'.number_format($rowIssue['price'],3).'</td>
		...
		<tr bgcolor="#f6f6f6">
			...
			<td align="top"><FONT SIZE=-1 color="#000066"><?php echo $LDTotalNumber2; ?></td>
			<td align="center"><FONT SIZE=-1 ><?php echo number_format($report_show['totalcost'],3); ?></td>
		</tr> 
		<tr>
