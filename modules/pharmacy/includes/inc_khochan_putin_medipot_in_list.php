...
<table border=0 cellpadding=3 width="98%">
		<tr bgcolor="#f6f6f6">
			...
			<td width="15%"><FONT SIZE=-1  color="#000066"><?php echo $LDGotVTYT; ?></td>
	...
	<tr>
		<td colspan="4" align="center"><br>
			<table bgcolor="#EEEEEE" width="100%" cellpadding="2">
				<tr bgColor="#E1E1E1" >
					...
					<td width="25%" align="center" rowspan="2"><u><?php echo $LDMedipotName; ?></u></td>
					...
					<td width="9%" align="center" rowspan="2"><u><?php echo $LDTotalPrice ?></u></td>
		...
		<?php for($i=1;$i<=$medicine_count;$i++) { 			
			...
			echo '<tr bgColor="#ffffff" >
					...
					<td align="center" bgColor="#ffffff"><input id="totalcost'.$i.'" type="text" size="5" value="'.($rowReport['price']*$rowReport['number']).'" style="border-color:white;border-style:solid;" readonly></td>
