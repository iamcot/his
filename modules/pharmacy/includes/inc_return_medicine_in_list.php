...
<table border=0 cellpadding=3 width="98%">
		<tr bgcolor="#f6f6f6">
			...
			<td width="15%"><FONT SIZE=-1  color="#000066"><?php echo $LDReturn; ?></td>
		...
		<td colspan="4" align="center"><br>
			<table bgcolor="#EEEEEE" width="100%" cellpadding="2">
				<tr bgColor="#E1E1E1" >
					...
					<td width="25%" align="center"><u><?php echo $LDMedicineName2; ?></u></td>
					<td width="8%" align="center"><u><?php echo $LDUnit ?></u></td>
