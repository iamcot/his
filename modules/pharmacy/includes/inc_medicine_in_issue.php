...
<table border=0 cellpadding=3 width="98%">
    ...
    <tr bgcolor="#f6f6f6">
		...
		<td width="35%"><FONT SIZE=-1  ><?php echo '<b>'.$issue_show['name_formal'].'</b> - '.$wardname; ?></td>
		...
		<td colspan="4" align="center"><br>
			<table bgcolor="#EEEEEE" width="100%" cellpadding="2">
				<tr bgColor="#E1E1E1" >
					...
					<td width="10%" align="center" rowspan="2"><font color="#E41B17"><u><?php echo $LDTonKhoLe ?></u></font></td>
