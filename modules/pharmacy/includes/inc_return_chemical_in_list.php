...
<table border=0 cellpadding=3 width="98%">
    ...
    <tr bgcolor="#f6f6f6">
        ...
        <td>
            <FONT SIZE=-1 ><input name="user_accept" type="text" size="24" value="<?php echo $_SESSION['sess_user_name']; ?>" style="border-color:white;border-style:solid;" readonly>
            </FONT>
        </td>
        <td>
            <FONT SIZE=-1 color="#000066">
