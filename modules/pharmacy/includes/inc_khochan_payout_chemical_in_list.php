...
<table border=0 cellpadding=3 width="98%">
		<tr bgcolor="#f6f6f6">
			...
			<td width="15%"><FONT SIZE=-1  color="#000066"><?php echo $LDGotChemicalDrug; ?></td>
   ...
   <tr bgcolor="#f6f6f6">
		...
		<td><FONT SIZE=-1  ><?php echo '<input name="total_money" id="total_money" type="text" size="12" value="'.$report_show['totalcost'].'" style="border-color:white;border-style:solid;"  readonly>'; ?></td>
   </tr> 
	<tr bgcolor="#f6f6f6">
	...
	<tr>
		<td colspan="4" align="center"><br>
			<table id="my_table_1" bgcolor="#EEEEEE" width="100%" cellpadding="2">
				<tr bgColor="#E1E1E1" >
					...
					<td width="25%" align="center" rowspan="2"><u><?php echo $LDChemicalName1; ?></u></td>
					...
					<td width="9%" align="center" rowspan="2"><u><?php echo $LDPrice ?></u></td>
					<td width="15%" align="center" colspan="2"><u><?php echo $LDNumber ?></u></td>
		...
		<?php 
			...
			echo '<tr bgColor="#ffffff" >
					...
					<td align="center" bgColor="#ffffff"><input id="cost'.$i.'" type="text" size="4" value="'.$rowReport['price'].'" style="border-color:white;border-style:solid;" readonly></td>
					<td align="center" bgColor="#ffffff"><b>'.$rowReport['number'].'</b></td>
					<td align="center" bgColor="#ffffff"><input name="receive['.$i.']" id="receive'.$i.'" type="text" size=3 value="'.$rowReport['number'].'" onBlur="CalCost('.$i.')" ></td>
					<td align="center" bgColor="#ffffff"><input id="totalcost'.$i.'" type="text" size="5" value="'.($rowReport['price']*$rowReport['number']).'" style="border-color:white;border-style:solid;" readonly />'.$rowReport['short_name'].'</td>
