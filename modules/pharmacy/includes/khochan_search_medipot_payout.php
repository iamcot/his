...
function searchItem(){
	...
	xmlhttp.open("GET","khochan_search_medipot_payout_getdb.php?name_med="+name_med+"&name_ger_med="+name_ger_med+"&group_med="+group_med+"&supplier="+supplier+"&typeput="+typeput,true);
