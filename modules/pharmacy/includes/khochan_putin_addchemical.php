<?php
	...
	echo '<tr style="height:auto" bgColor="#ffffff">
                ...
                <td class="cell1"><input class="input3" type="text" name="chemical'.$i.'" id="chemical'.$i.'" value="'.$rowReport['product_name'].'"  onFocus="Chemical_AutoComplete('.$i.');" >&nbsp;<a href="javascript:searchChemical('.$i.')"><img src="../../gui/img/common/default/search_radio.jpg"></a><div id="hint"></div></td>
                <td class="cell1"><input class="input2" type="text" name="unit'.$i.'" id="unit'.$i.'" value="'.$rowReport['unit_name_of_chemical'].'"  ></td>
                ...
                <td class="cell1"><input class="input2" type="text" name="cost'.$i.'" id="cost'.$i.'" value="'.$rowReport['price'].'" onBlur="CalCost('.$i.')"></td>
                <td class="cell1"><input class="input2" type="text" name="number'.$i.'" id="number'.$i.'" value="'.$rowReport['number'].'" onBlur="CalCost('.$i.')"></td>
                <td class="cell1">&nbsp;</td>
                <td class="cell1"><input class="input2" type="text" name="totalcost'.$i.'" id="totalcost'.$i.'" value="'.($rowReport['price']*$rowReport['number']).'"></td>
