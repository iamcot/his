...
{ 
	if($medicine = $Cabinet->getMedicineInDestroy($nr)){
		...
		$Cabinet->insertArchive($dept_nr, $ward_nr, $encoder, $lotid, '0', $number, 0, 0, 0, 0, $report_id, $user_accept, $typeput);
...
$patmenu="../pharma_request_medipot_destroy.php".URL_REDIRECT_APPEND."&target=$target&pid=".$_SESSION['sess_pid']."&user_origin=".$user_origin;
