...
?>
<TITLE><?php
	echo $LDRequestKhoChanPutInMedipot; ?>
</TITLE>
...
function printOut()
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/nhapkhochanVTYT.php<?php echo URL_APPEND; ?>&report_id=<?php echo $report_id; ?>&type=medipot";
...
{
	urlholder="<?php echo $root_path;?>modules/pdfmaker/duoc/bienbankiemnhapkhochan.php<?php echo URL_APPEND; ?>&report_id=<?php echo $report_id; ?>&type=medipot";
	testprintpdf=window.open(urlholder,"PhieuNhapKho","width=1000,height=760,menubar=yes,resizable=yes,scrollbars=yes");
...
?>
	...
	<table border=0 cellpadding=3 width="98%">
		<tr><td colspan="4" align="center"><b> <?php echo $LDRequestKhoChanPutInMedipot; ?> </b> <br> &nbsp; </td></tr>
		<tr bgcolor="#f6f6f6">
