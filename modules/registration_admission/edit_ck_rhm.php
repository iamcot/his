...
$_POST['encounter_nr']=$encounter_nr;
	...
	header("location:show_chuyenkhoa_ehm.php".URL_REDIRECT_APPEND."&target=$target&mode=details&encounter_nr=".$encounter_nr."&nr=".$nr);
										exit;
	}
}
...
$smarty->assign('sDocsBlockIncludeFile','registration_admission/form-rhm-edit.tpl');
$smarty->assign('sMainBlockIncludeFile','registration_admission/main-rhm.tpl');
