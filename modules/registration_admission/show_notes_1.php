...
//error_reporting(E_COMPILE_ERROR|E_ERROR|E_CORE_ERROR);
    ...
    if(!isset($type_nr)||!$type_nr) $type_nr=4; //* 1 = history physical notes
    ...
    if($type_nr==4 || $type_nr==99 || $type_nr==3){
    ...
    switch ($this_type['nr']){
        case 4:
            //hội chẩn
            header('Location:show_notes_hoichan.php'.URL_APPEND.'&pid='.$_SESSION['sess_pid'].'&target='.$target);
            break;
        default :
