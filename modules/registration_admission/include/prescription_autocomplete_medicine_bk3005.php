...
switch($mode){
	case 'auto': 
				$sql=" SELECT khochan.product_encoder, khochan.product_name, khochan.unit_of_medicine, khochan.price, khochan.caution, khochan.content, khochan.component, donvi.unit_name_of_medicine, khole.available_product_id, khole.product_lot_id, khole.exp_date, sum(khole.allocation_temp) AS allocation_temp, thuocgoc.generic_drug, thuocgoc.using_type    
