...
require_once($root_path.'include/core/inc_front_chain_lang.php');
	...
	$sql="SELECT khochan.product_encoder, khochan.product_name, donvi.unit_name_of_medicine, khole.product_lot_id, khole.exp_date, 
			khole.available_number, typemed.type_name_of_med, grp.name_sub, sup.supplier, sup.supplier_name 
