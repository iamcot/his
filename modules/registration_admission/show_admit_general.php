<?php
    ...
    */
    ...
    /* Load GUI page */
    if($flag=='KS_all')
        require('./gui_bridge/default/gui_show_admit_KS_general_all.php');
    else if($flag=='KS_s'){
        require('./gui_bridge/default/gui_show_admit_KS_general.php');
    }else if($flag=='KS_p'){
        require('./gui_bridge/default/gui_show_admit_KS_general.php');
    }else
        require('./gui_bridge/default/gui_show_admit_general.php');
?>
