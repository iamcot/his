...
function printout(pn){
	urlholder="<?php echo $root_path ?>modules/pdfmaker/khambenh/PhieuKhamBenhVaoVien.php<?php echo URL_APPEND; ?>&enc="+pn;
...
if(file_exists($root_path.'cache/barcodes/en_'.$encounter_nr.'.png')) {
	...
	$smarty->assign('referrer_diagnosis','<textarea name="referrer_diagnosis" id="referrer_diagnosis" style="width:85%;font-family:tahoma,arial;font-size:14px;" rows="5">'.$stemp.'</textarea>'.$sBuf);
	//end
...
*/
$smarty->assign('sMainBlockIncludeFile','registration_admission/admit_input_kbvv.tpl');
