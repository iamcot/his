...
switch($target){
	...
	case 'archiv':$fileforward='aufnahme_list.php'.$append;
						$lognote='Admission archive ok';
						 break;
	case 'report':$fileforward='aufnahme_report.php'.$append;
						$lognote='Admission report ok';
						 break;
...
if(defined('ADMISSION_EXT_TABS') && ADMISSION_EXT_TABS){
	...
	if($target=="report") echo '<img '.createLDImgSrc($root_path,'adminreport-blue.png','0').'  alt="Báo cáo">';
		else{ echo '<a href="aufnahme_pass.php?sid='.$sid.'&target=report&lang='.$lang.'"><img '.createLDImgSrc($root_path,'adminreport-gray.gif','0').' alt="Báo cáo" ';if($cfg['dhtml'])echo'class="fadeOut" '; echo '></a>';}
?>
	</td>
</tr>
