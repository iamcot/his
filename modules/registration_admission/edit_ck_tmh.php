...
$_POST['encounter_nr']=$encounter_nr;
	...
	header("location:show_chuyenkhoa_tmh.php".URL_REDIRECT_APPEND."&target=$target&mode=details&encounter_nr=".$encounter_nr."&nr=".$nr);
										exit;
	}
}
...
$smarty->assign('sDocsBlockIncludeFile','registration_admission/form-tmh-edit.tpl');
$smarty->assign('sMainBlockIncludeFile','registration_admission/main-tmh.tpl');
