...
$pres_all_types = $pres_obj->getPrescriptionChemicalTypes();	//BH hay BT
...
$file_autocomplete= 'include/prescription_autocomplete_chemical.php';
$sepChars=array('-','.','/',':',',');
...
if ($mode=='update'){
	...
	$detail_pres = $pres_obj->getPrescriptionChemicalInfo($pres_id);
	if($detail_pres){
	...
	$medicine_result = $pres_obj->getAllChemicalInPres($pres_id);
...
function chkform(d) {
	...
	document.reportform.action="include/save_chemical.inc.php";
...
function searchMedicine(id_number)
{
	...
	var typeput = a[1];
	var win = 'search_chemical.php?' + 'id_number=' + id_number +"&typeput="+typeput;
...
<table border=0 cellpadding="2" width="100%">
    <tr>
		...
		<td width="17%"><FONT color="#000066"><?php echo $LDChemical; ?></td>
   ...
   <tr>
		...
		<td><FONT color="#000066">
			...
			?></td>
		<td valign="top"><FONT color="#000066"><?php if($mode=='update') echo $LDGotHC; ?></td>
	...
	<tr>
		<td colspan="4"><FONT color="#000066"><?php echo $LDChemical1.'<p>'; ?></td>
	</tr>	
	<tr>
		<td colspan="4">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#E1E1E1"> 	<?php //-- Them thuoc vao toa thuoc -- ?>
					...
					<td>						<!-- Thuoc -->
						<table id="tblMedicine" bgColor="#E1E1E1" cellpadding="2" cellspacing="1" border="0" width="100%">
							<tr  bgColor="#EEEEEE">
								...
								<td align="center" width="35%" height="40"><?php echo $LDChemicalName; ?></td>
								<td align="center" width="10%"><?php echo $LDInventoryHC; ?></td>
				...
				<tr>
					<td colspan="2" bgColor="#EEEEEE" height="25"><a href="javascript:;" onclick="insertRow();" ><?php echo '&nbsp;['.$LDAddRowChemical.']&nbsp;'; ?></a></td>
				</tr>
			</table>
    ...
    <tr>
		...
		<td><textarea name="note" cols="35" rows="3" wrap="physical" ><?php if($mode=='update') echo $note1; ?> </textarea>
		</td>
	...
	<tr>
		<td colspan="4" ><FONT SIZE=1  FACE="Arial"> <?php echo $LDNoteChemicalPres; ?></td>
	</tr>
</table>
