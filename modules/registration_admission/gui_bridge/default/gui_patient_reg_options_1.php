          ...
          <TD>
            <TABLE cellSpacing=1 cellPadding=2 border=0>
              <TBODY class="submenu">
				...
				<a href="<?php echo $root_path."modules/nursing/nursing-station-patientdaten-doconsil-chemlabor.php".URL_APPEND."&pn=".$_SESSION['sess_en'] ?>&edit=1&status=&target=chemlabor&user_origin=lab&noresize=1&mode=">
                    <?php echo $LDTestMedLab ?>
                </a>
				 <?php }else{ 
				 echo $LDTestMedLab;
				 } ?>
                ...
                <TD vAlign=top width=150><FONT
                  face="Verdana,Helvetica,Arial" size=2>
				  <?php if(!$is_discharged && $remove ){ ?>
				<a  href="<?php echo $root_path."modules/nursing/nursing-station-patientdaten-doconsil-patho.php".URL_APPEND."&pn=".$_SESSION['sess_en'] ?>&edit=1&status=&target=patho&user_origin=lab&noresize=1&mode=">
                    <?php echo $LDTestPathLab ?>
                </a>
				  <?php }else{
				  echo $LDTestPathLab;
				  }?>
