...
/////////////// add 16/11-Huỳnh ////////////////
if($data_entry){
	$TP_REQUEST="<a href=\"".$root_path."modules/medocs/show_medocs.php".URL_APPEND."&encounter_nr=".$_SESSION['sess_en']."&edit=$edit&from=$from&is_discharged=$is_discharged&target=$target\">$LDRequestForPatient</a>";
}else{
	$TP_REQUEST="<font color='#333333'>$LDRequestForPatient</font>";
}
///////////////////////////////////////////////
...
if(!$enc_status['is_discharged']){
	$TP_BILLING="<a href=\"".$root_path."modules/ecombill/patientbill.php".URL_APPEND."&patientno=".$encounter_nr."&edit=$edit&full_en=".$_SESSION['sess_en']."&is_discharged=$is_discharged&target=$target\">$LDBilling</a>";
}else{
