...
# If person is dead show a black cross and assign death date
    ...
    if($encounter_class_nr==1){
        $smarty->assign('sListRecLink','<a href="show_obstetrics_question.php'.URL_APPEND."&pid=".$pid.'&target='.$target.'">'.$LDShowDocList3.'</a>');
        $smarty->assign('sListRecLink1',"<a href=\"show_pregnancy_question.php".URL_APPEND."&pid=$pid&target=$target\">$LDShowDocList4</a>");
    }else{
        $smarty->assign('sListRecLink',$LDShowDocList3);
        $smarty->assign('sListRecLink1',$LDShowDocList4);
    }    
...
$smarty->assign('sMainBlockIncludeFile','medocs/main_general_1.tpl');
