...
<TABLE cellSpacing=0 cellPadding=0 class="submenu_frame" border=0>
        ...
        <TR>
          <TD>
           ...
           <?php Spacer(); ?>  
		   <TR>  <td align=center><img <?php echo createComIcon($root_path,'health-checks.gif','0','',FALSE) ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2> 
			 <a href="kham_suc_khoe.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>">Khám sức khỏe</a>
				   </FONT></TD>
                </TR>				 
...
<!-- 				   
 ...
 -->         
			<?php Spacer(); ?>
              ...
              <TR><td align=center><img <?php echo createComIcon($root_path,'pharma.jpg','0','',FALSE) ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2> <nobr>
				 <a href="show_prescription.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>&type=sheet"><?php echo $LDSheetTreatment; ?></a>
				  </nobr> </FONT></TD>
               </TR>
			...
			<?php Spacer(); ?>
              ...
              <TR><td align=center><img <?php echo createComIcon($root_path,'pharma.jpg','0','',FALSE) ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2> <nobr>
				 <a href="show_prescription.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>&type=pres"><?php echo $LDPrescription; ?></a>
				  </nobr> </FONT></TD>
               </TR>
			   
			<?php Spacer(); ?>
				  
              <TR><td align=center><img <?php echo createComIcon($root_path,'storage.gif','0','',FALSE) ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2> <nobr>
				 <a href="show_depot.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>"><?php echo $LDDepot; ?></a>
				  </nobr> </FONT></TD>
               </TR>   
			   
						<?php Spacer(); ?>
				  
            <TR><td align=center><img <?php echo createComIcon($root_path,'Chemical.jpg','0','',FALSE) ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2> <nobr>
				 <a href="show_chemical.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>"><?php echo $LDChemical; ?></a>
				  </nobr> </FONT></TD>
               </TR>     
<!-- 			   
           <?php Spacer(); ?>
 ...
 -->				
      	<?php Spacer(); ?>
              ...
              <TR><td align=center><img <?php echo createComIcon($root_path,'new_group.gif','0','',FALSE) ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2> <nobr>
				 <a href="show_notes_1.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>"><?php echo "$LDNotes $LDAndSym $LDReports" ?></a>
				  </nobr> </FONT></TD>
                </TR>
           <?php Spacer(); ?>
