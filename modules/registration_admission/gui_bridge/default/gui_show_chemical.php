...
{
	var win = 'show_prescription_chemical_detail.php<?php echo URL_APPEND; ?>' + '&pid=' + pid + '&enc_nr='+ enc_nr +'&pres_id=' + pres_id;
...
?>
	<table border=0 cellpadding=4 cellspacing=1 width=100% class="frame">
		<tr bgcolor="#85A4CD"><td colspan="3" ><font color="#ffffff"><b><?php echo $LDListChemical; ?></b></td></tr>
	<?php
	...
	?>
		...
		<tr bgcolor="<?php echo $bgc; ?>" >
			<td ><FONT SIZE=-1  FACE="Arial">
				...
				<b><?php echo $LDPrescriptionChemicalId.": ".$row['prescription_id']."    "; ?></b>
			</td>
			...
			<td width="15%" align="right">	
				<a href="<?php	if($row['status_bill'])
								...
								elseif ($row['in_issuepaper']!='0')
									...
									echo $thisfile.URL_APPEND.'&pid='.$_SESSION['sess_pid'].'&target='.$target.'&mode=update&pres_id='.$row['prescription_id']; 
						?>"> 
