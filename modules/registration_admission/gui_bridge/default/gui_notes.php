...
ob_start();
	...
	if($parent_admit)  include('./gui_bridge/default/gui_patient_encounter_showdata_notes.php');
		else include('./gui_bridge/default/gui_patient_encounter_showdata_notes.php');
...
$smarty->assign('sMainBlockIncludeFile','registration_admission/common_option_khac.tpl');
