...
# Title in the toolbar
 ...
 //$smarty->assign('pbBack',$returnfile.URL_APPEND.$retbuf.'&target='.$target.'&mode=show&type_nr='.$type_nr);== goi duong dan neu bam quay lai
			...
			<TBODY>
				<TR>
					<TD>
						...
						<TBODY class="submenu" >
<!--	
//hien thi 2 dong yello_paper v� target khong dung duoc				
<tr>
...
?>
							<TR>
								...
								<TD vAlign=top >
									<a href="show_notes_2.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>&type_nr=<?php echo $v['nr'] ?>">
<?php
