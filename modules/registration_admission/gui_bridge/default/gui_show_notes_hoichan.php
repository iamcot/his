<script language="javascript">
    function printOut() {
	urlholder="<?php echo $root_path ?>modules/pdfmaker/chuyenvien/Bienbanhoichan.php<?php echo URL_APPEND ?>&enc_nr=<?php echo $_SESSION['sess_en'] ?>&nr=<?php echo $row['nr'] ?>";
...
<table border=0 cellpadding=4 cellspacing=1 width=100% class="frame">
    <tr bgcolor="#f6f6f6">
        <td <?php echo $tbg; ?>></td>
        <td <?php echo $tbg; ?> align="center"><FONT color="darkred"><b><?php echo $LD['hoichan_notes']; ?></b></FONT></td>
        ...
        <td <?php echo $tbg; ?> align="center"><FONT color="darkred"><b><?php echo $NrNgayhoichan; ?></b></FONT></td>
...
?>
    <tr bgcolor="#fefefe">
        ...
        <td>
            <?php 
                echo @formatDate2Local($row['date_hoichan'],$date_format); 
            ?>
        </td>
        <td>
            <?php 
                echo $row['time_hoichan']; 
            ?>
        </td>
        <td align="center">
