...
<?php
		...
		while(list($z,$x)=each($fields)){
			...
			if($x=='nr'||$x=='encounter_nr'||$x=='status'||$x=='history'||$x=='create_id'||$x=='create_time'||$x=='modify_id'||$x=='modify_time'||empty($pregbuf[$show_preg_enc][$x])) continue;
	...
	<?php 
			...
			switch($x){
				case 'date_khamngoai': 
                                    ...
                                    break;
                                case 'timthai':
                                    echo $pregbuf[$show_preg_enc][$x].'  '.$LD['dvtimthai'];
                                    break;
                                case 'chieucaotc':
