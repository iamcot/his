...
if($medicine_in_pres = $pres->getAllChemicalInPres($pres_id))
	$medicine_count = $medicine_in_pres->RecordCount();
...
echo '<FONT SIZE=-1  FACE="Arial"><p><b>'.$LDPrescriptionChemicalId.': '.$pres_show['prescription_id'].'</b></p>';
?>
	<table border=0 cellpadding=3 width="95%">
		<tr bgcolor="#f6f6f6">
			...
			<td width="20%"><FONT SIZE=-1  FACE="Arial" color="#000066"><?php echo $LDChemical; ?></td>
	   ...
	   <tr bgcolor="#f6f6f6">
			...
			<td><FONT SIZE=-1  FACE="Arial" color="#000066"><?php echo $LDGotHC; ?></td>
			<td><FONT SIZE=-1  FACE="Arial">
				<?php
						echo $tempfinish.' ';?>
			...
			<td colspan="4" align="center"><br>
				<table bgcolor="#EEEEEE" width="100%" cellpadding="3">
					<tr bgcolor="#ffffff">
						...
						<td align="center"><FONT SIZE=-1  FACE="Arial"><u><?php echo $LDChemicalName; ?></u></td>
		...
		<tr>
			<td colspan="4" align="left"><FONT SIZE=1  FACE="Arial"> <?php if($bill || $pres_show['status_bill']) echo $LDNoteMedicineBill; else echo $LDNoteChemicalPres; ?></td>
		</tr>
