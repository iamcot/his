...
if(!isset($mode)){
	...
	//$_POST['toanthan_notes']='';
//	$_POST['tuanhoan_notes']='';
//	$_POST['hohap_notes']='';
//	$_POST['tieuhoa_notes']='';
//	$_POST['thantietnieusinhduc_notes']='';
//	$_POST['thankinh_notes']='';
//	$_POST['coxuongkhop_notes']='';
//	$_POST['taimuihong_notes']='';
//	$_POST['ranghammat_notes']='';
//	$_POST['mat_notes']='';
//	$_POST['khac_notes']='';
	$redirect=true;
...
if($mode=='show') 
{
	$sql="SELECT e.encounter_nr,e.is_discharged,nd.nr,nd.personell_name, nd.toanthan_notes,nd.tuanhoan_notes,nd.hohap_notes,nd.tieuhoa_notes,nd.thantietnieusinhduc_notes,
					nd.thankinh_notes,nd.coxuongkhop_notes,nd.taimuihong_notes,nd.ranghammat_notes,nd.mat_notes,nd.khac_notes,nd.date
		FROM 	care_encounter AS e,
					care_encounter_khambenh AS nd				
...
/* Load GUI page */
require('./gui_bridge/default/gui_show_admit.php');
?>
