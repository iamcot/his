...
if($_COOKIE['ck_login_logged'.$sid]) $breakfile=$root_path.'main/startframe.php'.URL_APPEND;
	else $breakfile='aufnahme_pass_pdf.php'.URL_APPEND.'&target=entry';
...
$smarty->assign('LDKhambenhtt',$LDKhambenhtt);
	$smarty->assign('khambenhtoanthan',$khambenhtoanthan);
	$smarty->assign('LDKhambenhbp',$LDKhambenhbp);
	$smarty->assign('khambenhbophan',$khambenhbophan);
	$smarty->assign('LDKetqualamsang',$LDKetqualamsang);
	$smarty->assign('ketquacanlamsang',$ketquacanlamsang);
	$smarty->assign('LDChandoanbenhchinh',$LDChandoanbenhchinh);
	$smarty->assign('benhchinh',$benhchinh);
	$smarty->assign('LDChandoanbenhphu',$LDChandoanbenhphu);
	$smarty->assign('benhphu',$benhphu);
	$smarty->assign('LDTinhtrangravien',$LDTinhtrangravien);
	$smarty->assign('tinhtrangravien',$tinhtrangravien);
	$smarty->assign('LDHuongdieutri',$LDHuongdieutri);
	$smarty->assign('huongdieutritiep',$huongdieutritiep);
/*
...
$smarty->assign('sInsStartDayInput',@formatDate2Local($insurance_start,$date_format));
$smarty->assign('LDInsuranceExp',$LDInsuranceExp);
$smarty->assign('sInsExpDayInput',@formatDate2Local($insurance_exp,$date_format));
$smarty->assign('LDNoicap',$LDNoicap);
$smarty->assign('insurance_loca',$insurance_loca);
//end add
...
if(!$is_discharged){
	...
	ob_start();
		...
		include('./include/bottom_controls_admission_bant.inc.php');
		$sTemp = ob_get_contents();
...
$smarty->assign('sMainBlockIncludeFile','registration_admission/admit_show_bant.tpl');
