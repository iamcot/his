...
$smarty->assign('lidovaovien',$lidovaovien);
	...
	$smarty->assign('thuongtichvao',$thuongtichvao);
	$smarty->assign('LDThuongtichra',$LDThuongtichra);
	$smarty->assign('thuongtichra',$thuongtichra);
	/*
...
$smarty->assign('sInsStartDayInput',@formatDate2Local($insurance_exp,$date_format));
...
if(!$is_discharged){
	...
	ob_start();
		...
		include('./include/bottom_controls_admission_cntt.inc.php');
		$sTemp = ob_get_contents();
...
$smarty->assign('sMainBlockIncludeFile','registration_admission/admit_show_cntt.tpl');
