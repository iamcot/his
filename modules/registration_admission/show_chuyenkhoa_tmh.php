...
$page_title='Bệnh án Tai - Mũi - Họng';
...
if($mode=='show') 
{
	$sql="SELECT e.encounter_nr,e.is_discharged,tmh.*
		FROM 	care_encounter AS e,
					care_ck_tmh AS tmh
					
		WHERE  e.encounter_nr=".$encounter_nr."
			AND e.encounter_nr=tmh.encounter_nr 
			
			ORDER BY tmh.create_time DESC";
...
/* Load GUI page */
require('./gui_bridge/default/gui_show_ck_tmh.php');
?>
