...
function sendValue(name){
	...
	window.close();
	window.opener.Fill_Data_Search(<?php echo $id_number; ?>);
}
...
function searchItem(){
	...
	xmlhttp.open("GET","include/search_medicine_getdb.php?name_med="+name_med+"&name_ger_med="+name_ger_med+"&group_med="+group_med+"&supplier="+supplier+"&typeput="+typeput,true);
	xmlhttp.send();
