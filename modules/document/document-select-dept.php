...
switch($target){
	case 'create': $title=$LDCreateDocument;
					  $fileforward='document-create-new.php'.URL_APPEND.'&retpath='.$retpath;
					  break;
	case 'plist': $title=$LDViewDocument;
					  $fileforward='doctors-dienst-personalliste.php'.URL_APPEND.'&retpath='.$retpath;
					  break;
	default: $title=$LDViewDocument;
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',$LDDocumentManagement.": ".$title);
