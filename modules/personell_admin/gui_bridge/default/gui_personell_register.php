...
<td rowspan=6 align="center" class="photo_id"><img <?php echo $img_source ?>>
</td>
</tr>
<!--
<tr>
...
<td colspan=2 class="adm_input"><input name="short_id" type="text" size="30"  maxlength="20" value="<?php echo $short_id; ?>" >
</td>
</tr>
...
<?php
  $sql="select nr,name from care_type_job ";
  $temp=$db->execute($sql);
  if($temp->RecordCount()){
  while($result=$temp->FetchRow()){
  if($job_function_title==$result["nr"]) $selected="selected";else $selected="";
	echo '<option value="'.$result["nr"].'">'.$result["name"].'</option>';
...
<tr>
<td class="adm_item"><?php echo $LDTrinhDo; ?>:
</td>
<td colspan=2 class="adm_input">
	<select name="degree">
...
<td colspan=2 class="adm_input"><select name="contract_class">
<option value="HDNBC">HDNBC</option>
...
<td colspan=2 class="adm_input">
<?php if($pay_class=='tiền mặt'){
echo '<label><input type="radio" name="pay_class" value="tiền mặt" id="cash" checked>Tiền mặt</label> 
<label><input type="radio" name="pay_class" value="atm" id="atm">ATM</label> ';
} else{
echo '<label><input type="radio" name="pay_class" value="tiền mặt" id="cash">Tiền mặt</label> 
<label><input type="radio" name="pay_class" value="atm" id="atm" checked>ATM</label> ';
} ?>
<!--<input name="pay_class" type="text" size="30" maxlength="25" value="<?php echo $pay_class; ?>" >-->
</td>
</tr>
<tr id="box">
<td class="adm_item">
...
<td colspan=2 class="adm_input">
<input type="text" name="atm_number"size="30" value="<?php echo $atm_number ?>">
<!--<input name="pay_class" type="text" size="30" maxlength="25" value="<?php echo $pay_class; ?>" >-->
</td>
</tr>
<tr>
...
<!--add 27/12/2011-->
<tr>
<td class="adm_item"><?php echo $LDBHYT ?>:
</td>
<td colspan=2 class="adm_input"><input id="insurance_nr" name="insurance_nr" type="text" size="30" maxlength="25" value="<?php echo $insurance_nr; ?>" >
</td>
</tr>
<tr>
<td class="adm_item"><?php echo $LDBHXH ?>:
</td>
<td colspan=2 class="adm_input"><input name="bhxh" type="text" size="30" maxlength="25" value="<?php echo $bhxh; ?>" >
</td>
</tr>
<tr>
<td class="adm_item"><?php echo $LDSalaryGrading ?>:
</td>
<td colspan=2 class="adm_input"><input id="hsl" name="salary_grading" type="text" size="30"  value="<?php echo $salary_grading; ?>" >
</td>
</tr>
<tr>
<td class="adm_item"><?php echo $LDHeSoChucVu ?>:
</td>
<td colspan=2 class="adm_input"><input id="hscv" name="heso_chucvu" type="text" size="30"  value="<?php echo $heso_chucvu; ?>" >
</td>
</tr>
<tr>
<td class="adm_item"><?php echo $LDHeSoDocHai ?>:
</td>
<td colspan=2 class="adm_input"><input id="hsdh" name="heso_dochai" type="text" size="30"  value="<?php echo $heso_dochai; ?>" >
</td>
</tr>
<tr>
<td class="adm_item"><?php echo $LDTileuudai ?>:
</td>
<td colspan=2 class="adm_input"><input id="tlud" name="tlud" type="text" size="30"  value="<?php echo $tlud; ?>" >
</td>
</tr>
<!-- -->
<tr>
...
<tr>
<td class="adm_item"><?php echo $LDAdmitBy1 ?>:
</td>
