...
<td colspan=2   class="adm_input">
<?php $sql="select chucvu_nr from care_personell_assignment where personell_nr='".$full_pnr."'";
$temp=$db->Execute($sql);
$temp->recordcount();
$row=$temp->fetchrow();
if ($row['chucvu_nr']==0){$chucvu='Không';}
...
<td colspan=2   class="adm_input">
<?php echo  $personell_obj->getNameJobFunction($job_function_title); 
?>
</td>
</tr>
<tr bgcolor="white">
...
<tr bgcolor="white">
<td class="adm_item">&nbsp;<?php echo $LDATMNumber ?>:
</td>
<td colspan=2 class="adm_input">&nbsp;<?php echo $atm_number; ?>
</td>
</tr>
<tr bgcolor="white">
...
<td colspan=2 class="adm_input">&nbsp;<?php echo $insurance_nr; ?>
</td>
</tr>
<tr bgcolor="white">
<td class="adm_item">&nbsp;<?php echo $LDBHXH ?>:
</td>
<td colspan=2 class="adm_input">&nbsp;<?php echo $bhxh; ?>
</td>
</tr>
<tr bgcolor="white">
...
<td colspan=2 class="adm_input">&nbsp;<?php echo $heso_dochai; ?>
</td>
</tr>
<tr bgcolor="white">
<td class="adm_item">&nbsp;<?php echo $LDTileuudai ?>:
</td>
<td colspan=2 class="adm_input">&nbsp;<?php echo $tlud; ?>
</td>
</tr>
<tr bgcolor="white">
