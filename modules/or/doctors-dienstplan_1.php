...
$dept_obj->preloadDept(87);

require_once($root_path.'include/care_api_classes/class_personell.php');
$pers_obj=new Personell;
$role_nr = 15;
$dutyplan=&$pers_obj->getDOCDutyplan(87,$role_nr,$pyear,$pmonth);
...
function popinfo(l)
{
	...
	ww=400;
	wh=400;
	urlholder="doctors-dienstplan-popinfo.php<?php echo URL_REDIRECT_APPEND ?>&nr="+l+"&dept_nr=87&ward_nr=63&route=validroute&user=<?php echo $aufnahme_user.'"' ?>;
...
# Previous month
$sBuffer = '<a href="'.$thisfile.URL_APPEND.'&retpath='.$retpath.'&dept_nr=87&ward_nr=63&pmonth=';
