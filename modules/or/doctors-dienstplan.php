...
switch($retpath)
{
	...
	case "qview": $rettarget=$root_path.'main/op-doku_1.php'.URL_APPEND.'&hilitedept=39'; break;
...
function popinfo(l)
{
	...
	ww=400;
	wh=400;
	urlholder="doctors-dienstplan-popinfo.php<?php echo URL_REDIRECT_APPEND ?>&nr="+l+"&dept_nr=39&route=validroute&user=<?php echo $aufnahme_user.'"' ?>;
...
# Previous month
$sBuffer = '<a href="'.$thisfile.URL_APPEND.'&retpath='.$retpath.'&dept_nr=39&pmonth=';
