...
<table cellSpacing="0" cellPadding="3" border="0" width="90%">
	<tr><th align="left" colspan="2"><font size="3" color="#5f88be">{{$deptname}}</th></tr>
	<tr><th align="left" colspan="2"><font size="2" color="#85A4CD">{{$ward}}</th></tr>
	<tr>
		<td align="center" colspan="2"><font class="prompt"><b>{{$titleForm}}</b></td>
	</tr>
    <tr>
	...
	<tr>
		<td align="right" colspan="2">{{$IssueId}}</td>
	</tr>
