...
<!-- Lower block for the main request information -->
	...
	<td valign=top>
		...
		<b>{{$LDMatType}}:</b><br>
		{{$LDPE}}&nbsp;{{$input_material_type_pe_la}}{{$LDLa}} <br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$input_material_type_pe_no}}{{$LDNo}}<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$input_material_type_pe_th}}{{$LDTh}}<br>
		{{$input_material_type_op_specimen}} {{$LDSpecimen}}<br>
		{{$input_material_type_shave}} {{$LDShave}}<br>
		{{$LDCytology}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$input_material_type_cytology_th}}{{$LDCytologyTh}} <br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$input_material_type_cytology_sa}}{{$LDCytologySa}} <br>		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$input_material_type_cytology_la}}{{$LDCytologyLa}} 
	</td>
