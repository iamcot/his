...
<tr>
	<td class="adm_item" align="right"><FONT  color="#0000cc"><b>{{$LDKCB}}</b> </FONT></td>
	<td class="adm_input"><input type="text" name="main_info_maso_kcb_bv" size=40 maxlength=40 value="{{$main_info_maso_kcb_bv}}">
      </td>
	</tr>
<tr>
