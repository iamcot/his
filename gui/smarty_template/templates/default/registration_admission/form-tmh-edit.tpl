...
<table border=0 cellpadding=2 width=100%>
	<tr bgcolor='#adadad'>
     <td colspan=2><font style="font-weight:bold;color:blue;">{{$LDKhambenhTMH}}</font></td>
   ...
   <tr bgcolor='#f6f6f6'>
     <td class="adm_item">{{$LDTai}}</td>
     <td>
			<textarea name='tai_notes' cols=60 rows=2 wrap='physical'>{{$sTai}}</textarea>
   	 </td>
   </tr>
     <tr bgcolor='#f6f6f6'>
     <td class="adm_item">{{$LDMui}}</td>
     <td>
			<textarea name='mui_notes' cols=60 rows=2 wrap='physical'>{{$sMui}}</textarea>
   	 </td>
   </tr>
   <tr bgcolor='#f6f6f6'>
