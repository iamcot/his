			...
			<tbody>
				<tr valign="top">
					<td>
						...
						{{include file="registration_admission/basic_data_1.tpl"}}
						{{if $bShowNoRecord}}
							{{include file="registration_admission/common_norecord.tpl"}}
						{{elseif $bShowEntryForm}}
							{{include file="registration_admission/report_input_form_1.tpl"}}
						{{else}}
							{{include file="registration_admission/report_frame_1.tpl"}}
						{{/if}}
